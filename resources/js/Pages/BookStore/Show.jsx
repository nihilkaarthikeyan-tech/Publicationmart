...
function FormatCard({ name, availability, price, blurb, href, cta }) {
    return (
        <div className="bg-[#faf8f3] border border-[#d8d1c1] p-6">
            <div className="flex items-baseline justify-between gap-4 mb-1">
                <h4 className="text-[20px] text-[#17150f]" style={SERIF}>{name}</h4>
                <span className="text-[22px] text-[#17150f]" style={SERIF}>{price}</span>
            </div>
            <p className="text-[10px] font-bold uppercase tracking-[.18em] text-[#856531] mb-3">{availability}</p>
            <p className="text-sm text-[#635c4e] mb-5 leading-relaxed">{blurb}</p>
            <Link
                href={href}
                className="block w-full py-3 bg-[#6e2530] hover:bg-[#5a1e27] text-[#faf8f3] text-sm font-bold text-center rounded-sm transition-colors active:translate-y-px"
            >
                {cta}
            </Link>
        </div>
...
export default function Show({ auth, book }) {
    ...
    return (
        <>
            ...
            <div className="bg-[#f0ece3] min-h-screen pt-16 pb-20">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <nav className="flex items-center justify-between gap-6 mb-12">
                        <ol className="flex items-center gap-3 text-sm font-medium tracking-tight min-w-0">
                            <li>
                                <Link href={route('welcome')} className="text-[#635c4e] hover:text-[#6e2530] transition-colors">Home</Link>
                            </li>
                            <li className="text-[#d8d1c1] select-none">/</li>
                            <li>
                                <Link href={route('book-store.index')} className="text-[#635c4e] hover:text-[#6e2530] transition-colors">Book Store</Link>
                            </li>
                            <li className="text-[#d8d1c1] select-none">/</li>
                            <li className="text-[#6e2530] font-semibold truncate max-w-[40ch]">{book.title}</li>
                        </ol>
                        ...
                        {auth?.user?.is_admin && (
                            <Link
                                ...
                                className="shrink-0 flex items-center gap-2 px-4 py-2 bg-[#6e2530] hover:bg-[#5a1e27] text-[#faf8f3] font-bold rounded-sm transition-colors text-sm"
                            >
                                Edit Book
                            </Link>
                        )}
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 sm:gap-16">
                        ...
                        <div className="lg:col-span-4">
                            ...
                            <div className="mt-12 space-y-4">
                                <div className="flex items-baseline gap-4">
                                    ...
                                    <span className="flex-1 h-px bg-[#d8d1c1]" />
                                </div>
                            ...
                            <div className="mt-12 space-y-4">
                                ...
                                <div className="grid grid-cols-1 gap-3">
                                    <a
                                        ...
                                        className={`flex items-center justify-between px-5 py-4 bg-[#faf8f3] border border-[#d8d1c1] hover:border-[#6e2530] text-[#17150f] rounded-sm transition-colors group ${!book.amazon_link ? 'opacity-50 cursor-not-allowed' : ''}`}
                                    >
                                        <span className="font-bold tracking-tight">Amazon Store</span>
                                        <span className="text-[#635c4e] group-hover:text-[#6e2530] group-hover:translate-x-1 transition-all" aria-hidden="true">→</span>
                                    </a>
                                    <a
                                        ...
                                        className={`flex items-center justify-between px-5 py-4 bg-[#faf8f3] border border-[#d8d1c1] hover:border-[#6e2530] text-[#17150f] rounded-sm transition-colors group ${!book.google_books_link ? 'opacity-50 cursor-not-allowed' : ''}`}
                                    >
                        ...
                        <div className="lg:col-span-8 space-y-14">
                            ...
                            <div>
                                ...
                                <h1 className="text-[clamp(2.4rem,5vw,4rem)] leading-[1.08] text-[#17150f] mb-4" style={SERIF}>
                                    {book.title}
                                </h1>
                                {book.subtitle && (
                                    <h2 className="text-2xl sm:text-3xl italic text-[#635c4e] leading-relaxed" style={SERIF}>
                                        {book.subtitle}
                                    </h2>
                                )}
                                ...
                                <div className="flex items-center gap-x-6 gap-y-4 pt-7 flex-wrap">
                                    <div className="flex items-center gap-3">
                                        <div className="w-11 h-11 rounded-full bg-[#6e2530] text-[#faf8f3] flex items-center justify-center text-[17px]" style={SERIF}>
                                            {book.author_name?.charAt(0)}
                                        </div>
                                        <div>
                                            <div className="text-[10px] text-[#635c4e] uppercase font-bold tracking-[.18em] mb-0.5">Written by</div>
                                            <div className="text-lg text-[#17150f]" style={SERIF}>{book.author_name}</div>
                                        </div>
                                    </div>

                                    {coAuthors.map((coAuthor, index) => (
                                        <div key={index} className="flex items-center gap-3">
                                            <div className="w-9 h-9 rounded-full bg-[#a07d3b] text-[#faf8f3] flex items-center justify-center text-[14px]" style={SERIF}>
                                                {coAuthor?.charAt(0)}
                                            </div>
                                            <div>
                                                <div className="text-[9px] text-[#635c4e] uppercase font-bold tracking-[.18em] mb-0.5">Co-Author</div>
                                                <div className="text-base text-[#17150f]" style={SERIF}>{coAuthor}</div>
                                            </div>
                                        </div>
                                    ))}
                                </div>
                            ...
                            <div className="grid grid-cols-2 md:grid-cols-4 gap-x-8 gap-y-6">
                                {[
                                    ...
                                    <div key={idx} className="pt-4 border-t border-[#d8d1c1]">
                                        <div className="pm-store-run mb-1.5" style={{ color: '#6e2530' }}>{stat.label}</div>
                                        <div className={`text-[15px] text-[#17150f] ${stat.dim ? 'opacity-50' : ''}`} style={SERIF}>
                                            {stat.value}
                                        </div>
                                    </div>
                                ))}
                            ...
                            {book.about_book && (
                                <div>
                                    <div className="flex items-baseline gap-4 mb-6">
                                        <h3 className="text-[26px] text-[#17150f]" style={SERIF}>About this book</h3>
                                        <span className="flex-1 h-px bg-[#d8d1c1]" />
                                    </div>
                                    <p className="text-[17px] text-[#4b443a] leading-[1.85] whitespace-pre-line max-w-[70ch] border-l-2 border-[#6e2530]/25 pl-6" style={SERIF}>
                                        {book.about_book}
                                    </p>
                                </div>
                            )}
                            ...
                            <div>
                                <div className="flex items-baseline gap-4 mb-2">
                                    <h3 className="text-[26px] text-[#17150f]" style={SERIF}>The edition</h3>
                                    <span className="flex-1 h-px bg-[#d8d1c1]" />
                                ...
                                <dl>
                                    {[
                                        ...
                                        <div key={i} className="grid grid-cols-[minmax(120px,180px)_1fr] gap-6 py-3 border-t border-[#d8d1c1] last:border-b">
                                            <dt className="pm-store-run pt-0.5">{spec.l}</dt>
                                            <dd className="text-[15px] text-[#17150f]" style={SERIF}>{spec.v}</dd>
                                        </div>
                                    ))}
                                </dl>
                            </div>
                            ...
                            {book.author_biography && (
                                <div className="bg-[#faf8f3] border border-[#d8d1c1] p-8 sm:p-10">
                                    <div className="flex flex-col sm:flex-row gap-8 items-start">
                                        <div className="w-16 h-16 rounded-full bg-[#6e2530] text-[#faf8f3] flex items-center justify-center text-[24px] shrink-0" style={SERIF}>
                                            {book.author_name?.charAt(0)}
                                        </div>
                                        <div>
                                            <div className="flex items-center gap-3 mb-1 flex-wrap">
                                                <h3 className="text-[24px] text-[#17150f]" style={SERIF}>About the author</h3>
                                                <span className="text-[9px] font-bold uppercase tracking-[.18em] px-2 py-0.5 border border-[#a07d3b]/50 text-[#856531] rounded-sm">Verified</span>
                                            </div>
                                            <p className="text-[17px] text-[#635c4e] mb-4" style={SERIF}>{book.author_name}</p>
                                            <p className="text-[15.5px] text-[#4b443a] leading-relaxed italic" style={SERIF}>
                                                {book.author_biography}
                                            </p>
                                        </div>
                                    </div>
                            ...
                            {/* Final conversion */}
                            <div className="border border-[#d8d1c1] bg-[#faf8f3] p-10 sm:p-14 text-center">
                                <h3 className="text-[clamp(1.6rem,3.5vw,2.3rem)] text-[#17150f] mb-3" style={SERIF}>
                                    Ready for this journey?
                                </h3>
                                <p className="text-[#635c4e] text-lg mb-8">Secure your physical copy or instant audiobook today.</p>
                                <div className="flex flex-col sm:flex-row gap-3 justify-center">
                                    <button
                                        onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })}
                                        className="px-9 py-4 bg-[#6e2530] hover:bg-[#5a1e27] text-[#faf8f3] font-bold rounded-sm transition-colors active:translate-y-px"
                                    >
                                        Explore Options
                                    </button>
                                    <Link
                                        href={route('book-store.index')}
                                        className="px-8 py-4 bg-transparent text-[#17150f] font-bold rounded-sm border border-[#d8d1c1] hover:border-[#6e2530] hover:text-[#6e2530] transition-colors text-center"
                                    >
                                        View Collective
                                    </Link>
                                </div>
                    ...
                    <div className="mt-20 text-center">
                        <Link
                            href={route('book-store.index')}
                            className="inline-flex items-center gap-3 text-[#635c4e] hover:text-[#6e2530] transition-colors group font-semibold"
                        >
