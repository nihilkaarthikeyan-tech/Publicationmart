                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <nav className="flex items-center justify-between mb-12">
                        <ol className="flex items-center gap-3 text-sm font-medium tracking-tight">
                            <li>
                                <Link href={route('welcome')} className="text-gray-500 hover:text-white transition-all flex items-center gap-1">
                            ...
                            <li>
                                <Link href={route('book-store.index')} className="text-gray-500 hover:text-white transition-all">Book Store</Link>
                            </li>
                            <li className="text-gray-700 select-none">/</li>
                            <li className="text-indigo-400 font-bold bg-indigo-500/10 px-3 py-1 rounded-full">{book.title}</li>
                        </ol>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 sm:gap-16">
                        ...
                        <div className="lg:col-span-4">
                            ...
                            <div className="group relative">
                                ...
                                <div className="relative bg-[#0f1118] rounded-[2rem] overflow-hidden border border-white/5 shadow-[0_22px_70px_4px_rgba(0,0,0,0.56)] transform transition-transform duration-500 group-hover:scale-[1.01]">
                                    {book.cover_design_path ? (
                                        ...
                                        <div className="aspect-[2/3] flex flex-col items-center justify-center text-gray-600 bg-[#12141c]">
                            ...
                            <div className="mt-10 space-y-5">
                                <h3 className="text-xs font-black uppercase tracking-[0.2em] text-gray-500 px-2 flex items-center gap-2">
                                    Choose Your Format
                                ...
                                {book.selling_price > 0 && (
                                    <div className="group relative bg-[#12141d]/80 backdrop-blur-md border border-white/5 rounded-3xl p-6 hover:bg-[#161925] transition-all duration-300">
                                        <div className="flex items-center justify-between mb-4">
                                            <div className="flex items-center gap-4">
                                                ...
                                                <div>
                                                    <h4 className="font-extrabold text-white text-lg">Hardcover</h4>
                                            ...
                                            <div className="text-right">
                                                <span className="text-2xl sm:text-3xl font-black text-white glow-text">
                                                    {currencyFormatter.format(book.selling_price)}
                                                </span>
                                            </div>
                                        </div>
                                        <p className="text-sm text-gray-400 mb-5 leading-relaxed">High-quality hardcover edition with premium paper texture. Ships to your doorstep.</p>
                                    ...
                                    <div className="group relative bg-[#12141d]/80 backdrop-blur-md border border-white/5 rounded-3xl p-6 hover:bg-[#161925] transition-all duration-300">
                                        <div className="flex items-center justify-between mb-4">
                                            <div className="flex items-center gap-4">
                                                ...
                                                <div>
                                                    <h4 className="font-extrabold text-white text-lg">E-Book</h4>
                                        ...
                                        <p className="text-sm text-gray-400 mb-5 leading-relaxed">Read instantly on any device. Compatible with Kindle, Apple Books, and PDF readers.</p>
                                    ...
                                    <div className="group relative bg-[#12141d]/80 backdrop-blur-md border border-white/5 rounded-3xl p-6 hover:bg-[#161925] transition-all duration-300">
                                        <div className="flex items-center justify-between mb-4">
                                            <div className="flex items-center gap-4">
                                                ...
                                                <div>
                                                    <h4 className="font-extrabold text-white text-lg">Audiobook</h4>
                                        ...
                                        <p className="text-sm text-gray-400 mb-5 leading-relaxed">Immersive narration. Listen on-the-go with high-quality audio streaming.</p>
                            ...
                            <div className="mt-12 space-y-4">
                                ...
                                <div className="grid grid-cols-1 gap-4">
                                    <a
                                        ...
                                        className={`flex items-center justify-between px-6 py-5 bg-[#232f3e] hover:bg-[#2b3a4a] text-white rounded-2xl transition-all border border-white/5 active:scale-95 group ${!book.amazon_link ? 'opacity-50 grayscale cursor-not-allowed' : ''}`}
                                    >
                                        <div className="flex items-center gap-4">
                                    ...
                                    <a
                                        ...
                                        className={`flex items-center justify-between px-6 py-5 bg-[#3c4043] hover:bg-[#4a4f54] text-white rounded-2xl transition-all border border-white/5 active:scale-95 group ${!book.google_books_link ? 'opacity-50 grayscale cursor-not-allowed' : ''}`}
                                    >
                                        <div className="flex items-center gap-4">
                        ...
                        <div className="lg:col-span-8 space-y-12">
                            ...
                            <div className="space-y-6">
                                <div className="flex items-center gap-4 flex-wrap">
                                    <span className="px-4 py-1.5 bg-indigo-500/10 text-indigo-400 text-xs font-black rounded-full uppercase tracking-widest border border-indigo-500/20 shadow-sm shadow-indigo-500/5">
                                ...
                                <div className="space-y-4">
                                    ...
                                    {book.subtitle && (
                                        <h2 className="text-2xl sm:text-3xl font-medium text-gray-500 italic leading-relaxed">
                                            {book.subtitle}
                                        </h2>
                                    )}
                                </div>
                                ...
                                <div className="flex items-center gap-4 pt-2 flex-wrap">
                                    <div className="w-14 h-14 rounded-[1.25rem] bg-gradient-to-tr from-indigo-500 to-purple-500 p-0.5 shadow-xl shadow-indigo-500/10">
                                        <div className="w-full h-full rounded-[1.1rem] bg-[#0a0b10] flex items-center justify-center font-black text-indigo-400 text-xl">
                                            {book.author_name?.charAt(0)}
                                        </div>
                                    </div>
                                    <div>
                                        <div className="text-xs text-gray-500 uppercase font-black tracking-widest leading-none mb-1">Written by</div>
                                        <div className="text-xl font-bold text-white hover:text-indigo-400 transition-colors cursor-pointer">{book.author_name}</div>
                                    </div>
                                                ...
                                                .map((coAuthor, index) => (
                                                    <div key={index} className="flex items-center gap-3">
                                                        <div className="w-10 h-10 rounded-xl bg-gradient-to-tr from-emerald-500 to-teal-500 p-0.5 shadow-lg shadow-emerald-500/10">
                                                            <div className="w-full h-full rounded-[0.6rem] bg-[#0a0b10] flex items-center justify-center font-bold text-emerald-400 text-sm">
                                                                {coAuthor?.charAt(0)}
                                                            </div>
                                                        </div>
                                                        <div>
                                                            <div className="text-[10px] text-gray-500 uppercase font-black tracking-widest leading-none mb-0.5">Co-Author</div>
                                                            <div className="text-base font-semibold text-white">{coAuthor}</div>
                                                        </div>
                                                    </div>
                                                ))}
                                        </>
                            ...
                            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                                {[
                                    ...
                                    <div key={idx} className="bg-[#12141d]/40 border border-white/5 p-5 rounded-3xl group hover:border-indigo-500/30 transition-all">
                                        <div className="text-xs text-gray-500 font-black uppercase tracking-widest mb-2 select-none">{stat.label}</div>
                                        <div className={`text-white font-bold text-base ${stat.mono ? 'font-mono tracking-tight' : ''} ${!stat.hl && stat.label === 'ISBN Identifier' ? 'opacity-30' : ''}`}>
                                            {stat.value}
                                        </div>
                                    </div>
                                ))}
                            ...
                            <div className="bg-[#12141d]/40 border border-white/5 rounded-[2.5rem] overflow-hidden">
                                <div className="px-8 py-6 border-b border-white/5 flex items-center justify-between bg-white/[0.02]">
                                    <h3 className="text-lg font-black text-white tracking-tight">Technical Specifications</h3>
                                    <div className="px-3 py-1 bg-white/5 rounded-full text-[10px] font-black uppercase text-gray-400">Retail Quality</div>
                                </div>
                                <div className="p-8 grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-6">
                                    {[
                                        ...
                                        <div key={i} className="flex items-center justify-between py-1 group">
                                            <span className="text-gray-500 font-medium text-sm group-hover:text-gray-400 transition-colors">{spec.l}</span>
                                            <span className="text-white font-bold text-sm tracking-tight">{spec.v}</span>
                                        </div>
                                    ))}
                                </div>
                            </div>
                            ...
                            {book.about_book && (
                                <div className="space-y-6">
                                    <div className="flex items-center gap-4">
                                        <h3 className="text-2xl font-black text-white tracking-tighter italic px-2">Narrative Overview</h3>
                                    ...
                                    <div className="relative">
                                        ...
                                        <p className="md:pl-8 text-lg text-gray-400 leading-[1.8] font-medium whitespace-pre-line selection:bg-indigo-500/30">
                                            {book.about_book}
                                        </p>
                                    </div>
                                </div>
                            ...
                            {book.author_biography && (
                                <div className="bg-[#12141d]/40 border border-white/5 rounded-[2.5rem] p-8 sm:p-12 relative overflow-hidden group">
                                    ...
                                    <div className="flex flex-col md:flex-row gap-10 items-center md:items-start relative z-10">
                                        <div className="relative">
                                            <div className="w-28 h-28 rounded-[2rem] bg-gradient-to-br from-indigo-500/20 to-purple-500/20 flex items-center justify-center flex-shrink-0 border border-white/5 shadow-2xl">
                                                <svg className="w-12 h-12 text-indigo-400 opacity-80" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        ...
                                        <div className="space-y-4 text-center md:text-left">
                                            <div>
                                                <div className="flex items-center justify-center md:justify-start gap-3 mb-1">
                                                    <h3 className="text-2xl font-black text-white tracking-tight">Meet the Author</h3>
                                                    <span className="text-[10px] font-black uppercase tracking-[0.2em] px-2 py-0.5 bg-emerald-500/10 text-emerald-400 border border-emerald-500/20 rounded-md">Verified</span>
                                                </div>
                                                <p className="text-xl font-bold text-gray-500">{book.author_name}</p>
                                            </div>

                                            <div className="relative">
                                                <svg className="absolute -top-4 -left-6 w-12 h-12 text-white/5 pointer-events-none" fill="currentColor" viewBox="0 0 32 32">
                                                ...
                                                <p className="text-gray-400 leading-relaxed text-lg font-medium relative z-10 italic">
                                                    {book.author_biography}
                                                </p>
                                            </div>
                                        </div>
                            ...
                            <div className="relative group p-10 sm:p-16 rounded-[3.5rem] overflow-hidden border border-white/5 shadow-2xl">
                                ...
                                <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-10">
                                    <div className="text-center md:text-left space-y-3">
                                        <h3 className="text-4xl font-black text-white tracking-tighter">Ready for this journey?</h3>
                                        <p className="text-gray-400 text-lg sm:text-xl font-medium max-w-md">Secure your physical copy or instant audiobook today.</p>
                                    </div>
                                    <div className="flex flex-col sm:flex-row gap-4 w-full md:w-auto">
                                        ...
                                        <Link
                                            ...
                                            className="px-8 py-5 bg-white/5 text-white font-bold rounded-2xl border border-white/10 hover:bg-white/10 transition-all text-center"
                                        >
                                            View Collective
                                        </Link>
                                    </div>
                    ...
                    <div className="mt-24 text-center">
                        <Link
                            href={route('book-store.index')}
                            className="inline-flex items-center gap-4 text-gray-500 hover:text-white transition-all group font-bold"
                        >
