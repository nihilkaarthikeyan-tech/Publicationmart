                ...
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <nav className="mb-8">
                        <ol className="flex items-center gap-2 text-sm">
                            <li>
                                <Link href={route('welcome')} className="text-gray-400 hover:text-white transition">
                                    Home
                                </Link>
                            </li>
                            <li className="text-gray-600">/</li>
                            <li>
                                <Link href={route('book-store.index')} className="text-gray-400 hover:text-white transition">
                                    Book Store
                                </Link>
                            </li>
                            <li className="text-gray-600">/</li>
                            <li>
                                <Link href={route('book-store.show', book.id)} className="text-gray-400 hover:text-white transition">
                                    {book.title}
                                </Link>
                            </li>
                            <li className="text-gray-600">/</li>
                            <li className="text-indigo-400">Cart</li>
                        </ol>
                    </nav>
                        ...
                        <div className="lg:col-span-2 space-y-4">
                            ...
                            <div className="bg-[#15161b] rounded-2xl border border-white/10 p-6">
                                <div className="flex gap-6">
                                    {/* Book Cover */}
                                    <div className="w-24 h-32 flex-shrink-0 rounded-lg overflow-hidden bg-gray-800">
                                    ...
                                    <div className="flex-1">
                                        <div className="flex justify-between items-start">
                                            ...
                                            <div className="text-right">
                                                <div className="text-xl font-bold text-white">₹{unitPrice.toFixed(2)}</div>
                                        ...
                                        <div className="mt-4 flex items-center gap-4">
                                            ...
                                            <div className="flex items-center gap-2">
                                                <button
                                                    ...
                                                    className="w-8 h-8 rounded-lg bg-gray-700 hover:bg-gray-600 text-white flex items-center justify-center transition"
                                                >
                                                    -
                                                </button>
