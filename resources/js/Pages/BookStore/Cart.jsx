                ...
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <nav className="mb-8">
                        <ol className="flex items-center gap-2 text-sm">
                            <li>
                                <Link href={route('welcome')} className="text-umber hover:text-ink transition">
                                    Home
                                </Link>
                            </li>
                            <li className="text-umber">/</li>
                            <li>
                                <Link href={route('book-store.index')} className="text-umber hover:text-ink transition">
                                    Book Store
                                </Link>
                            </li>
                            <li className="text-umber">/</li>
                            <li>
                                <Link href={route('book-store.show', book.id)} className="text-umber hover:text-ink transition">
                                    {book.title}
                                </Link>
                            </li>
                            <li className="text-umber">/</li>
                    ...
                    {/* Cart Header */}
                    <div className="mb-8">
                        <h1 className="text-3xl font-bold text-ink mb-2">Your Cart</h1>
                        <p className="text-umber">Complete your purchase</p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                        ...
                        <div className="lg:col-span-2 space-y-4">
                            {/* Cart Item Card */}
                            <div className="bg-parchment rounded-2xl border border-linen p-6">
                                <div className="flex gap-6">
                                    {/* Book Cover */}
                                    <div className="w-24 h-32 flex-shrink-0 rounded-lg overflow-hidden bg-paper">
                                    ...
                                    <div className="flex-1">
                                        <div className="flex justify-between items-start">
                                            ...
                                            <div className="text-right">
                                                <div className="text-xl font-bold text-ink">₹{unitPrice.toFixed(2)}</div>
                                                <div className="text-xs text-umber">per unit</div>
                                            </div>
                                        </div>

                                        {/* Quantity Selector */}
                                        <div className="mt-4 flex items-center gap-4">
                                            <span className="text-umber text-sm">Quantity:</span>
                            ...
                            <Link
                                ...
                                className="inline-flex items-center gap-2 text-umber hover:text-ink transition text-sm"
                            >
                        ...
                        <div className="lg:col-span-1">
                            <div className="bg-parchment rounded-2xl border border-linen p-6 sticky top-8">
                                <h2 className="text-lg font-bold text-ink mb-4">Order Summary</h2>

                                <div className="space-y-3 text-sm">
                                    <div className="flex justify-between text-umber">
                                        <span>Subtotal ({quantity} item{quantity > 1 ? 's' : ''})</span>
                                        <span className="text-ink">₹{subtotal.toFixed(2)}</span>
                                    </div>
                                    <div className="flex justify-between text-umber">
                                        <span>GST (18%)</span>
                                        <span className="text-ink">₹{gst.toFixed(2)}</span>
                                    </div>
                                    <div className="border-t border-linen pt-3 mt-3">
                                ...
                                <div className="mt-4 flex items-center justify-center gap-2 text-xs text-umber">
