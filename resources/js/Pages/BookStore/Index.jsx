...
export default function BookStoreIndex({ auth, books }) {
    ...
    return (
        <>
            ...
            {/* Dark Hero Section */}
            <div className="bg-[#1c1912] relative overflow-hidden pt-20 pb-12">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
                    ...
                    <div className="mt-10 max-w-xl mx-auto">
                        <div className="relative group">
                            ...
                            <div className="relative bg-[#262019] rounded-full flex items-center p-2 border border-violet-800/50 shadow-xl">
            ...
            <div className="bg-[#1c1912] min-h-screen py-12 border-t border-violet-800/30">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    {filteredBooks.length > 0 ? (
                        ...
                        <div className="text-center py-32">
                            <div className="inline-flex items-center justify-center w-20 h-20 bg-[#262019] rounded-full mb-6 border border-violet-800/50 shadow-lg">
