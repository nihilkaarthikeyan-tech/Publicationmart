...
export default function BookStoreIndex({ auth, books }) {
    ...
    return (
        <>
            ...
            {/* Dark Hero Section */}
            <div className="bg-[#f0ece3] relative overflow-hidden pt-20 pb-12">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
                    <h1 className="text-4xl md:text-6xl font-black text-[#17150f] tracking-tight mb-6">
                        Discover Your Next <span className=" text-[#6e2530]">Great Read</span>
                    </h1>
                    ...
                    <div className="mt-10 max-w-xl mx-auto">
                        <div className="relative group">
                            ...
                            <div className="relative bg-[#faf8f3] rounded-full flex items-center p-2 border border-[#d8d1c1] shadow-xl">
                                ...
                                <input
                                    ...
                                    className="w-full bg-transparent border-none text-[#17150f] placeholder-gray-500 focus:ring-0 px-4 py-2"
                                    value={searchQuery}
            ...
            <div className="bg-[#f0ece3] min-h-screen py-12 border-t border-[#d8d1c1]">
