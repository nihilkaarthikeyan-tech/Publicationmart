        ...
        <div className="min-h-screen bg-[#f0ece3] flex items-center justify-center p-6 relative overflow-hidden font-sans selection:bg-indigo-500 selection:text-[#17150f]">
            ...
            <div className="w-full max-w-md relative z-10">
                ...
                <div className="text-center mb-8">
                    ...
                    <h2 className="mt-4 text-2xl font-bold text-[#17150f] tracking-tight">Recover access</h2>
                    <p className="mt-2 text-[#635c4e] text-sm">Enter your email and we'll send a reset link</p>
                </div>
                ...
                <div className="bg-[#faf8f3] border border-gray-800 rounded-2xl p-8 shadow-2xl backdrop-blur-xl">
                        ...
                        <div>
                            ...
                            <div className="relative group">
                                <div className="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none">
                                    <svg className="h-5 w-5 text-[#635c4e] group-focus-within:text-indigo-700 transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                ...
                                <TextInput
                                    ...
                                    name="email"
                                    value={data.email}
                                    className="block w-full pl-11 pr-4 py-3 border border-gray-800 rounded-xl bg-[#faf8f3] text-[#4b443a] placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-indigo-500/50 focus:border-indigo-500/50 transition-all text-sm"
                    ...
                    <div className="mt-8 pt-6 border-t border-gray-800 text-center">
                        <Link href={route('login')} className="text-sm font-semibold text-[#635c4e] hover:text-[#17150f] transition-colors flex items-center justify-center gap-2">
