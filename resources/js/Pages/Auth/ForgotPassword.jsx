        ...
        <div className="min-h-screen bg-[#0a0b0f] flex items-center justify-center p-6 relative overflow-hidden font-sans selection:bg-indigo-500 selection:text-white">
            ...
            <div className="w-full max-w-md relative z-10">
                ...
                <div className="text-center mb-8">
                    ...
                    <h2 className="mt-4 text-2xl font-bold text-white tracking-tight">Recover access</h2>
                    <p className="mt-2 text-gray-400 text-sm">Enter your email and we'll send a reset link</p>
                </div>
                ...
                <div className="bg-[#15161a] border border-gray-800 rounded-2xl p-8 shadow-2xl backdrop-blur-xl">
                        ...
                        <div>
                            ...
                            <div className="relative group">
                                ...
                                <TextInput
                                    ...
                                    name="email"
                                    value={data.email}
                                    className="block w-full pl-11 pr-4 py-3 border border-gray-800 rounded-xl bg-[#1a1b20] text-gray-100 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-indigo-500/50 focus:border-indigo-500/50 transition-all text-sm"
                    ...
                    <div className="mt-8 pt-6 border-t border-gray-800 text-center">
                        <Link href={route('login')} className="text-sm font-semibold text-gray-400 hover:text-white transition-colors flex items-center justify-center gap-2">
