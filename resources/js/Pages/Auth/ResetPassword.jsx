        ...
        <div className="min-h-screen bg-[#f0ece3] flex items-center justify-center p-6 relative overflow-hidden font-sans selection:bg-indigo-500 selection:text-[#17150f]">
            ...
            <div className="w-full max-w-md relative z-10">
                ...
                <div className="text-center mb-8">
                    ...
                    <h2 className="mt-4 text-2xl font-bold text-[#17150f] tracking-tight">Set new password</h2>
                </div>
                ...
                <div className="bg-[#faf8f3] border border-gray-800 rounded-2xl p-8 shadow-2xl backdrop-blur-xl">
                    <form onSubmit={submit} className="space-y-6">
                        ...
                        {/* Password */}
                        <div>
                            <label className="block text-sm font-medium text-[#4b443a] mb-1.5" htmlFor="password">New Password</label>
                            <div className="relative group">
                                <div className="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none">
                                    <svg className="h-5 w-5 text-[#635c4e] group-focus-within:text-indigo-700 transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" />
                        ...
                        <div>
                            <label className="block text-sm font-medium text-[#4b443a] mb-1.5" htmlFor="password_confirmation">Confirm Password</label>
                            <div className="relative group">
                                <div className="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none">
                                    <svg className="h-5 w-5 text-[#635c4e] group-focus-within:text-indigo-700 transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor">
