        ...
        <div className="min-h-screen bg-[#0a0b0f] flex items-center justify-center p-6 relative overflow-hidden font-sans selection:bg-indigo-500 selection:text-white">
            ...
            <div className="w-full max-w-md relative z-10">
                ...
                <div className="text-center mb-8">
                    ...
                    <h2 className="mt-4 text-2xl font-bold text-white tracking-tight">Set new password</h2>
                </div>
                ...
                <div className="bg-[#15161a] border border-gray-800 rounded-2xl p-8 shadow-2xl backdrop-blur-xl">
                    <form onSubmit={submit} className="space-y-6">
                        ...
                        <div>
                            <label className="block text-sm font-medium text-gray-300 mb-1.5" htmlFor="password_confirmation">Confirm Password</label>
                            <div className="relative group">
                                <div className="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none">
                                    <svg className="h-5 w-5 text-gray-500 group-focus-within:text-indigo-400 transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor">
