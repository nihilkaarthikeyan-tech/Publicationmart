                        ...
                        <div className="space-y-6">
                            ...
                            <div>
                                ...
                                <div className="grid grid-cols-4 gap-2">
                                    {[
                                        { type: 'rectangle', icon: <div className="w-8 h-5 bg-ink-soft rounded-sm"></div>, label: 'Rectangle' },
                                        { type: 'square', icon: <div className="w-6 h-6 bg-ink-soft rounded-sm"></div>, label: 'Square' },
                                        { type: 'circle', icon: <div className="w-6 h-6 bg-ink-soft rounded-full"></div>, label: 'Circle' },
                                        { type: 'roundedRect', icon: <div className="w-8 h-5 bg-ink-soft rounded-lg"></div>, label: 'Rounded' },
                                    ].map(shape => (
                                        <button
                                            key={shape.type}
                            ...
                            <div>
                                ...
                                <div className="grid grid-cols-4 gap-2">
                                    {[
                                        ...
                                        { type: 'diamond', icon: <div className="w-5 h-5 bg-ink-soft rotate-45"></div>, label: 'Diamond' },
                            ...
                            <div>
                                ...
                                <div className="grid grid-cols-3 gap-2">
                                    {[
                                        { type: 'line', icon: <div className="w-10 h-0.5 bg-ink-soft"></div>, label: 'Horizontal Line' },
                                        { type: 'lineVertical', icon: <div className="w-0.5 h-8 bg-ink-soft"></div>, label: 'Vertical Line' },
