                    ...
                    <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
                            ...
                            <div className={`lg:col-span-4 transition-all duration-700 delay-200 transform ${isMounted ? 'translate-x-0 opacity-100' : '-translate-x-10 opacity-0'} sticky top-24`}>
                                <div className="relative p-8 rounded-3xl bg-ink/40 backdrop-blur-sm border border-white/10">
                                    {/* Vertical Steps */}
                                    <div className="mb-8">
                                    ...
                                    <h1 className="text-4xl text-cream mb-4 leading-tight" style={{ fontFamily: "'EB Garamond', Georgia, serif" }}>
                                        Finalize & <br />
                                        <em className="text-foil-light">Monetize</em>
                                    </h1>
                            ...
                            <div className={`lg:col-span-8 transition-all duration-700 delay-400 transform ${isMounted ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
                                <div className="bg-white rounded-[2.5rem] shadow-2xl shadow-ink/10 border border-vellum overflow-hidden relative">
                                    {/* Card Header */}
                                    <div className="px-10 py-8 bg-gradient-to-r from-slate-50 to-white border-b border-vellum flex justify-between items-center">
                                        <div className="flex items-center gap-4">
                                            <Link
                                                href={route('books.design', book.id)}
                                                className="p-2 -ml-2 text-taupe hover:text-umber hover:bg-[#efe9db] rounded-full transition-colors"
                                                title="Go Back"
                                            >
                                            ...
                                            <div>
                                                <h2 className="text-xl font-bold text-ink">Details & Pricing</h2>
                                                <p className="text-umber text-sm mt-1">Final details to publish your book</p>
                                            </div>
                                        </div>
                                    ...
                                    <div className="p-8 lg:p-10">
                                        ...
                                        <form className="space-y-10" onSubmit={(e) => {
                                            ...
                                            <div>
                                                ...
                                                <div className="mb-6">
                                                    ...
                                                    <input
                                                        ...
                                                        inputMode="numeric"
                                                        pattern="\d*"
                                                        className="w-full px-4 py-3 border-2 border-linen focus:border-purple-500 focus:ring-2 focus:ring-purple-200 rounded-xl transition-all duration-200 font-medium text-ink"
                                                        placeholder="e.g. 250"
                                                        ...
                                                        required
                                                    />
                                                    <p className="text-xs text-umber mt-1">Total number of pages in your book</p>
                                                ...
                                                <div>
                                                    ...
                                                    <textarea
                                                        className="w-full px-4 py-3 border-2 border-linen focus:border-purple-500 focus:ring-2 focus:ring-purple-200 rounded-xl transition-all duration-200"
                                                        rows="4"
                                            ...
                                            <div>
                                                ...
                                                <div className="bg-paper p-4 rounded-xl border border-linen mb-6">
                                                    <div className="flex items-center justify-between mb-3">
                                                        <h4 className="text-sm font-bold text-umber uppercase tracking-wide">Your Book Configuration</h4>
                                                    ...
                                                    <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                                                        <div className="bg-white p-3 rounded-lg border border-vellum">
                                                            <div className="text-[10px] font-bold text-taupe uppercase tracking-wider">Book Size</div>
                                                            <div className="text-sm font-bold text-night mt-1">{book.book_size || '5.5x8.5'}"</div>
                                                        </div>
                                                        <div className="bg-white p-3 rounded-lg border border-vellum">
                                                            <div className="text-[10px] font-bold text-taupe uppercase tracking-wider">Printing</div>
                                                            <div className="text-sm font-bold text-night mt-1">{book.printing_color || 'B/W'}</div>
                                                        </div>
                                                        <div className="bg-white p-3 rounded-lg border border-vellum">
                                                            <div className="text-[10px] font-bold text-taupe uppercase tracking-wider">Paper Type</div>
                                                            <div className="text-sm font-bold text-night mt-1">{book.paper_type || 'White Paper'}</div>
                                                        </div>
                                                        <div className="bg-white p-3 rounded-lg border border-vellum">
                                                            <div className="text-[10px] font-bold text-taupe uppercase tracking-wider">Binding</div>
                                                            <div className="text-sm font-bold text-night mt-1">{book.binding_type || 'Soft Binding'}</div>
                                                        </div>
                                                    </div>
                                                    <p className="text-xs text-umber mt-3 flex items-center gap-1">
                                                ...
                                                <div className="bg-gradient-to-br from-blue-50 to-purple-50 p-8 rounded-2xl border-2 border-blue-100">
                                                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                                                        ...
                                                        <div className="bg-white p-6 rounded-xl shadow-sm border-2 border-linen">
                                                            <label className="block text-xs font-bold text-umber uppercase tracking-wide mb-2">
                                                            ...
                                                            <div className="bg-white p-4 rounded-xl border border-orange-200 shadow-sm flex items-center justify-between">
                                                                <div>
                                                                    <div className="flex items-center space-x-2 mb-1">
                                                                        ...
                                                                        <h5 className="font-bold text-ink">Amazon Royalty</h5>
                                                                    </div>
                                                                    <p className="text-xs text-umber">Price × 70% royalty</p>
                                                                </div>
                                                            ...
                                                            <div className="bg-white p-4 rounded-xl border border-blue-200 shadow-sm flex items-center justify-between">
                                                                <div>
                                                                    <div className="flex items-center space-x-2 mb-1">
                                                                        ...
                                                                        <h5 className="font-bold text-ink">Google Play Royalty</h5>
                                                                    </div>
                                                                    <p className="text-xs text-umber">Price × 70% royalty</p>
                                                                </div>
                                                    ...
                                                    <div className="mt-8">
                                                        <label className="block text-sm font-semibold text-ink-soft mb-2">
                                                            International Selling Price (USD) <span className="text-taupe font-normal">(Optional)</span>
                                                        </label>
                                                        <input
                                                            type="number"
                                                            step="0.01"
                                                            className="w-full md:w-1/3 px-4 py-3 border-2 border-linen focus:border-purple-500 focus:ring-2 focus:ring-purple-200 rounded-xl transition-all duration-200"
                                            ...
                                            <div>
                                                ...
                                                <div className="bg-orange-50 rounded-2xl p-8 border border-orange-100">
                                                    <p className="text-umber mb-6">
                                                        <span className="font-bold text-night">Optional:</span> Purchase your own books at <span className="font-bold text-orange-700">author cost</span>. If you choose to buy, minimum order is 5 copies.
                                                    </p>

                                                    <div className="flex flex-col md:flex-row gap-8 items-start">
                                                        <div className="w-full md:w-1/3">
                                                            <label className="block text-sm font-bold text-ink-soft mb-2">
                                                                Number of Copies <span className="text-taupe font-normal">(Optional)</span>
                                                            </label>
                                                            <input
                                                                type="number"
                                                                min="0"
                                                            ...
                                                            />
                                                            <p className="text-xs text-umber mt-1">Enter 0 (no purchase) or 5+ copies.</p>
                                                            {authorCopiesError && (
                                                        ...
                                                        <div className="w-full md:w-2/3 bg-white p-6 rounded-xl border border-orange-100 shadow-sm flex flex-col md:flex-row items-center justify-between">
                                                            <div>
                                                                <h4 className="text-sm font-bold text-umber uppercase tracking-wide">Total Cost for Author Copies</h4>
                                                            ...
                                                            <div className="mt-4 md:mt-0">
                                                                {authorCost <= 0 ? (
                                                                    ...
                                                                    <div className="text-right">
                                                                        ...
                                                                        <p className="text-xs text-umber">Proceed to bottom to pay</p>
                                                                    </div>
                                                                    ...
                                                                    <p className="text-sm text-taupe">Enter quantity to order (Min 5)</p>
                                                                )}
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            {parseInt(data.author_copies || 0) >= 5 && (
                                                <div id="dispatch-address-section">
                                                    ...
                                                    <p className="text-sm text-umber mb-4">Where should we send your author copies?</p>

                                                    <div className="bg-paper border border-linen rounded-xl p-6">
                                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                                            ...
                                                            <div className="md:col-span-2">
                                                                ...
                                                                <textarea
                                                                    className={`w-full px-4 py-3 border focus:ring-2 focus:ring-purple-200 rounded-lg transition-all ${addressErrors.street_address ? 'border-red-400 focus:border-red-500' : 'border-linen-deep focus:border-purple-500'
                                                                        }`}
                                                                    rows="2"
                                                            ...
                                                            <div>
                                                                ...
                                                                <input
                                                                    type="text"
                                                                    className={`w-full px-4 py-3 border focus:ring-2 focus:ring-purple-200 rounded-lg ${addressErrors.city ? 'border-red-400 focus:border-red-500' : 'border-linen-deep focus:border-purple-500'
                                                                        }`}
                                                            ...
                                                            <div>
                                                                ...
                                                                <select
                                                                    className={`w-full px-4 py-3 border focus:ring-2 focus:ring-purple-200 rounded-lg appearance-none bg-white ${addressErrors.state ? 'border-red-400 focus:border-red-500' : 'border-linen-deep focus:border-purple-500'
                                                                        }`}
                                                                    value={data.state}
                                                                    onChange={(e) => {
                                                            ...
                                                            <div>
                                                                ...
                                                                <input
                                                                    ...
                                                                    inputMode="numeric"
                                                                    maxLength="6"
                                                                    className={`w-full px-4 py-3 border focus:ring-2 focus:ring-purple-200 rounded-lg ${addressErrors.pincode ? 'border-red-400 focus:border-red-500' : 'border-linen-deep focus:border-purple-500'
                                                                        }`}
                                                            ...
                                                            <div>
                                                                ...
                                                                <div className="relative">
                                                                    <span className="absolute left-3 top-1/2 -translate-y-1/2 text-umber font-medium">+91</span>
                                                                    <input
                                                                        type="tel"
                                                                        inputMode="numeric"
                                                                        maxLength="10"
                                                                        className={`w-full pl-12 pr-4 py-3 border focus:ring-2 focus:ring-purple-200 rounded-lg ${addressErrors.phone_contact ? 'border-red-400 focus:border-red-500' : 'border-linen-deep focus:border-purple-500'
                                                                            }`}
                                                        ...
                                                        <p className="text-xs text-taupe mt-4 flex items-center">
                                            ...
                                            {/* Final Confirmations */}
                                            {/* Final Confirmations */}
                                            <div id="final-declaration" className="bg-paper p-6 rounded-2xl border border-linen">
                                                <h4 className="font-bold text-ink mb-4">Final Declaration & Approval</h4>
                                                <div className="space-y-4">
                                                    <label className="flex items-start gap-3 cursor-pointer group">
                                                        <div className="relative flex items-center">
                                                            <input
                                                                ...
                                                                className="w-5 h-5 text-indigo-600 rounded border-linen-deep focus:ring-indigo-500 cursor-pointer"
                                                            />
                                                        </div>
                                                        <span className="text-sm text-ink-soft font-medium group-hover:text-ink transition-colors">
                                                    ...
                                                    <label className="flex items-start gap-3 cursor-pointer group">
                                                        ...
                                                        <span className="text-sm text-ink-soft font-medium leading-relaxed group-hover:text-ink transition-colors">
                                    ...
                                    {/* Card Footer */}
                                    <div className="px-8 py-4 bg-paper border-t border-vellum text-center">
