                        ...
                        <div className="flex justify-between h-16 items-center">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-[11px] text-slate-400">Review before publishing</p>
                                </div>
                            </div>
                    ...
                    <div className="grid lg:grid-cols-12 gap-12 mb-16">
                        ...
                        <div className="lg:col-span-4 flex justify-center">
                            <div className="relative group">
                                ...
                                <div className="relative">
                                    ...
                                    <div className="relative w-60 sm:w-72 aspect-[2/3] rounded-xl overflow-hidden shadow-[0_25px_60px_-15px_rgba(0,0,0,0.2)] border border-white/50 transform group-hover:scale-[1.02] transition-transform duration-500">
                                        {book.cover_design_path ? (
                                            ...
                                            <div className="w-full h-full bg-gradient-to-br from-slate-100 to-slate-200 flex flex-col items-center justify-center text-slate-400 p-8 text-center">
                        ...
                        <div className="lg:col-span-8 flex flex-col justify-center">
                            <div className="text-center lg:text-left">
                                ...
                                {/* Subtitle */}
                                {book.subtitle && (
                                    <p className="text-xl text-slate-500 font-light mb-6 max-w-2xl mx-auto lg:mx-0">
                                        {book.subtitle}
                                    </p>
                                )}
                                ...
                                <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                                    {[
                                        ...
                                        <div key={idx} className={`bg-gradient-to-br ${stat.color} p-4 rounded-2xl border hover:shadow-md transition-shadow`}>
                                            <div className="text-slate-400 text-[10px] uppercase font-bold tracking-widest mb-1">{stat.label}</div>
                                    ...
                                    <div className="bg-white rounded-2xl border border-slate-200/60 shadow-sm p-8 sm:p-10">
                                        <div className="flex flex-col md:flex-row gap-8 items-start">
                                            ...
                                            <div className="flex-1">
                                                ...
                                                <div className="prose prose-slate text-slate-600 text-[15px] leading-relaxed">
                                                    {book.author_biography || (
                                                        <p className="italic text-slate-400">The author hasn't added a biography yet.</p>
                                                    )}
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div className="bg-white rounded-2xl border border-slate-200/60 shadow-sm p-8 sm:p-10">
                                        ...
                                        <div className="max-w-lg mx-auto space-y-4">
                                            <div className="flex items-center justify-between p-5 bg-slate-50 rounded-2xl border border-slate-200/60">
                                                <div>
                                                    <p className="text-xs text-slate-400 uppercase font-bold tracking-widest mb-1">Selling Price</p>
                                            ...
                                            <div className="flex items-center justify-between p-5 bg-red-50/50 rounded-2xl border border-red-100">
                                                <div>
                                                    <p className="text-xs text-slate-400 uppercase font-bold tracking-widest mb-1">Author Cost (Min. Price)</p>
                                                    <p className="text-xl font-bold text-red-500">- ₹{authorCost.toFixed(2)}</p>
                                                    <p className="text-[10px] text-slate-400 mt-0.5">Includes printing cost ₹{printingCost.toFixed(2)} + platform fee</p>
                                                </div>
                        ...
                        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
                            <div className="hidden sm:flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <div className="text-xs text-slate-400">Preview confirms content & layout matches your expectations.</div>
                                </div>
                            </div>
                            ...
                            <div className="flex items-center gap-3 w-full sm:w-auto">
                                <Link
                                    href={route('books.details', book.id)}
                                    className="px-6 py-3 rounded-xl border border-slate-200 text-slate-600 font-bold text-sm hover:bg-slate-50 hover:border-slate-300 transition-all w-full sm:w-auto text-center"
                                >
                                    Back
                                </Link>
                                <button
