                            ...
                            <div className={`lg:col-span-4 transition-all duration-700 delay-200 transform ${isMounted ? 'translate-x-0 opacity-100' : '-translate-x-10 opacity-0'} sticky top-24`}>
                                <div className="relative p-8 rounded-3xl bg-ink/40 backdrop-blur-sm border border-white/10">
                                    ...
                                    <h1 className="text-4xl text-cream mb-4 leading-tight" style={{ fontFamily: "'EB Garamond', Georgia, serif" }}>
                                        Design Your <br />
                                        <em className="text-foil-light">Masterpiece</em>
                                    </h1>
                                ...
                                <div className="bg-white rounded-[2.5rem] shadow-2xl shadow-ink/10 border border-vellum overflow-hidden relative">
                                    ...
                                    <div className="px-10 py-8 bg-gradient-to-r from-slate-50 to-white border-b border-vellum flex justify-between items-center">
                                        <div className="flex items-center gap-4">
                                            ...
                                            <div>
                                                <h2 className="text-xl font-bold text-ink">Book Configuration</h2>
                                                <p className="text-umber text-sm mt-1">Select your printing and layout preferences</p>
                                            </div>
                                        </div>
                                        ...
                                        <form className="space-y-10">
                                                    ...
                                                    {[
                                                        ...
                                                        <button
                                                            ...
                                                            className={`p-6 border-2 rounded-xl transition-all duration-200 text-left relative ${data.book_size === size.id
                                                                ...
                                                                : 'border-linen hover:border-purple-300 hover:bg-purple-50/30'
                                                                }`}
                                                        >
                                                            ...
                                                            <div className="text-center mb-3">
                                                                <div className="text-2xl font-bold text-ink mb-1">{size.label}</div>
                                                                <div className="text-xs text-umber font-medium">inches</div>
                                                            </div>
                                                            <div className="text-[10px] leading-tight text-umber font-bold uppercase tracking-wider text-center">
                                                                Recommended for:<br />
                                                ...
                                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                                    <button
                                                        ...
                                                        className={`p-6 border-2 rounded-xl transition-all duration-200 text-left ${data.printing_color === 'B/W'
                                                            ? 'border-purple-500 bg-gradient-to-br from-purple-50 to-blue-50 shadow-lg'
                                                            : 'border-linen hover:border-purple-300'
                                                            }`}
                                                    >
                                                        <div className="flex items-start justify-between mb-3">
                                                            <div className="p-2 bg-[#efe9db] rounded-lg">
                                                                <svg className="w-6 h-6 text-ink-soft" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                        ...
                                                        <h3 className="font-bold text-ink mb-1">Black & White</h3>
                                                        <p className="text-sm text-umber">Perfect for novels and text-heavy books</p>
                                                    </button>
                                                    ...
                                                    >
                                                        ...
                                                        <h3 className="font-bold text-ink mb-1">Full Color</h3>
                                                        <p className="text-sm text-umber">Great for children's books and illustrated guides</p>
                                                    </button>
                                                </div>
                                                    ...
                                                    {['White Paper', 'Bond Paper', 'Art Paper'].map((paper) => (
                                                        ...
                                                        >
                                                            ...
                                                            <div className="text-center">
                                                                <div className="font-bold text-ink">{paper}</div>
                                                            </div>
                                                        </button>
                                                    ))}
                                                </div>
                                            ...
                                            <div>
                                                ...
                                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                                    ...
                                                    >
                                                        ...
                                                        <h3 className="font-bold text-ink mb-1">Soft Binding</h3>
                                                        <p className="text-sm text-umber">Flexible paperback binding, perfect for novels</p>
                                                    </button>
                                                    ...
                                                    >
                                                        ...
                                                        <h3 className="font-bold text-ink mb-1">Hard Binding</h3>
                                                        <p className="text-sm text-umber">Durable hardcover binding, premium quality</p>
                                                    </button>
                                                </div>
                                            ...
                                            <div>
                                                ...
                                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                                    ...
                                                    >
                                                        ...
                                                        <h3 className="font-bold text-ink text-lg mb-2">Upload Formatted File</h3>
                                                        <p className="text-sm text-umber mb-3">Have a Word doc ready? Upload it here.</p>
                                                        ...
                                                        <div className="flex gap-3 mb-4">
                                                            <button
                                                                ...
                                                                className="flex-1 py-3 bg-white border-2 border-linen-deep rounded-xl text-sm font-semibold text-ink-soft hover:border-purple-400 transition-all"
                                                            >
                                                                Browse Templates
                                                            </button>
                                                ...
                                                <div className={`relative rounded-2xl p-8 overflow-hidden border-2 transition-all duration-300 ${(book.interior_file || data.interior_file)
                                                    ...
                                                    {(book.interior_file || data.interior_file) && (
                                                        <div className="absolute inset-0 z-20 bg-white/70 backdrop-blur-[2px] flex flex-col items-center justify-center p-6 rounded-2xl">
                                                            ...
                                                            <h4 className="text-lg font-bold text-night mb-2 text-center">Formatting Tool Locked</h4>
                                                            <p className="text-sm text-umber text-center max-w-sm mb-4">
                                                    ...
                                                    <div className={`relative z-10 ${(book.interior_file || data.interior_file) ? 'opacity-30 pointer-events-none select-none' : ''}`}>
                                                        <div className="flex items-start justify-between mb-4">
                                                            <div className="flex items-center">
                                                                ...
                                                                <div>
                                                                    <h3 className="text-xl font-bold text-ink">Professional Formatting Tool</h3>
                                                                    <p className="text-sm text-umber mt-1">Format your manuscript with our advanced online editor</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-6">
                                                            <div className="bg-white p-3 rounded-lg text-center">
                                                                ...
                                                                <div className="text-xs text-umber mt-1">Smart styling</div>
                                                            </div>
                                                            <div className="bg-white p-3 rounded-lg text-center">
                                                                <div className="text-purple-600 font-bold text-sm">Templates</div>
                                                                <div className="text-xs text-umber mt-1">Pre-designed</div>
                                                            </div>
                                                            <div className="bg-white p-3 rounded-lg text-center">
                                                                <div className="text-purple-600 font-bold text-sm">Export PDF</div>
                                                                <div className="text-xs text-umber mt-1">Print-ready</div>
                                                            </div>
                                                            <div className="bg-white p-3 rounded-lg text-center">
                                                                <div className="text-purple-600 font-bold text-sm">Cloud Save</div>
                                                                <div className="text-xs text-umber mt-1">Auto-save</div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div className="flex flex-col gap-3">
                                                            ...
                                                            <div className="bg-purple-50 p-4 rounded-xl border border-purple-100">
                                                                <div className="flex justify-between items-center mb-3">
                                                                    <span className="text-xs font-bold text-umber uppercase tracking-wider">Struggling with formatting?</span>
                                            ...
                                            <div>
                                                ...
                                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                                    ...
                                                    <div className="relative group bg-gradient-to-br from-indigo-50 to-purple-50 border-2 border-indigo-200 rounded-2xl p-8 hover:shadow-2xl transition-all">
                                                        ...
                                                        <h3 className="text-xl font-bold text-ink mb-3">Professional Cover Creator</h3>
                                                        <p className="text-umber text-sm mb-4">Design stunning covers with our advanced studio. Unlimited stock images, professional typography, ready-made layouts.</p>
                                                    ...
                                                    <div className="border-2 border-linen rounded-2xl p-6 hover:border-purple-300 transition-all flex flex-col h-full">
                                                        <h3 className="font-bold text-ink text-lg mb-4">Upload Custom Cover</h3>

                                                        {/* Image Preview Area */}
                                                        {(data.cover_design_path || book.cover_design_path) ? (
                                                            <div className="mb-4 relative group rounded-xl overflow-hidden border border-linen shadow-sm bg-paper">
                                                        ...
                                                        <div className={`border-2 border-dashed border-linen-deep rounded-xl p-6 text-center hover:bg-paper transition-colors relative cursor-pointer flex-1 flex flex-col justify-center items-center ${data.cover_design_path ? 'border-green-400 bg-green-50/10' : ''}`}>
                                                            <svg className={`mx-auto h-12 w-12 mb-4 ${data.cover_design_path ? 'text-green-500' : 'text-taupe'}`} fill="none" stroke="currentColor" viewBox="0 0 48 48">
                                                            ...
                                                            <p className="text-sm text-umber mb-2">
                                                                <span className="font-semibold text-purple-600">{data.cover_design_path ? 'Change file' : 'Upload a file'}</span> or drag and drop
                                                            </p>
                                                            <p className="text-xs text-umber font-bold mb-1">Recommended Size: 755 x 1144 px</p>
                                                            <p className="text-[10px] text-taupe">PNG, JPG up to 10MB</p>
                                                            <input
                                                                type="file"
                                                                accept=".jpg,.jpeg,.png"
                                            ...
                                            <div className="pt-6 flex gap-4">
                                                <button
                                                    ...
                                                    onClick={() => submit('back')}
                                                    disabled={processing}
                                                    className="w-1/3 flex items-center justify-center px-6 py-4 bg-white border-2 border-linen text-ink-soft text-lg font-bold rounded-xl shadow-sm hover:border-violet-300 hover:bg-violet-50 transition-all duration-200 disabled:opacity-50"
                                                >
                                                    ← Back
                                                </button>
                ...
                showTemplateModal && (
                    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4" onClick={() => setShowTemplateModal(false)}>
                        <div className="bg-white rounded-3xl shadow-2xl w-full max-w-4xl max-h-[90vh] overflow-hidden flex flex-col" onClick={(e) => e.stopPropagation()}>
                            ...
                            {/* Modal Header */}
                            <div className="p-8 border-b border-vellum flex justify-between items-center bg-gradient-to-r from-purple-50 to-blue-50">
                                <div>
                                        ...
                                        <div className="p-6">
                                            <div className="flex items-center gap-5 mb-6">
                                                ...
                                                <div>
                                                    ...
                                                    <p className="text-sm text-umber font-medium">Professional Layout</p>
                                                </div>
                                            </div>
                            ...
                            {/* Modal Footer */}
                            <div className="p-6 border-t border-vellum bg-white flex items-center gap-4">
                                <div className="w-10 h-10 rounded-full bg-blue-50 flex items-center justify-center text-blue-600">
                                    <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 20 20">
                                        <path fillRule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clipRule="evenodd" />
                                    </svg>
                                </div>
                                <p className="text-xs text-umber font-medium leading-relaxed">
                                    <span className="text-ink font-bold">Pro Tip:</span> After downloading, simply replace the placeholder text with your content. All margins, fonts, and headers are already perfectly set for a <span className="text-purple-600 font-bold">{data.book_size}</span> book.
                                </p>
                            </div>
                        </div>
                    </div>
