...
export default function AiBookStudio({ book, auth }) {
    ...
    return (
        <div className={`min-h-screen flex flex-col font-sans transition-colors duration-500 ${step === 0 ? 'bg-[#17150f]' : step >= 1 && step <= 5 ? 'bg-[#0a0f1a]' : 'bg-gray-50'}`}>
            ...
            {/* Header */}
            <header className={`h-16 flex items-center justify-between px-6 shadow-sm z-50 transition-colors duration-500 ${step >= 0 && step <= 5 ? 'bg-[#0d1220]/90 backdrop-blur-md border-b border-white/10' : 'bg-white border-b'}`}>
                <div className="flex items-center gap-4">
                    ...
                    <h1 className="font-bold text-lg flex items-center gap-2 text-white">
                        ...
                        {book.title}
                        <span className="text-xs px-2 py-0.5 rounded-full uppercase tracking-wider font-bold bg-indigo-500/20 text-indigo-300 border border-indigo-500/30">Smart Writer Studio</span>
                    </h1>
                </div>
                ...
                <div className={`flex items-center gap-2 text-sm ${step === 0 ? 'opacity-0 pointer-events-none hidden md:flex' : ''}`}>
                    {[1, 2, 3, 4, 5].map(s => (
                        <button
                            ...
                            disabled={s > step + 1}
                            className={`flex items-center gap-2 ${step >= s ? 'text-indigo-400 font-bold' : 'text-gray-500'}`}
                        >
                            <div className={`w-8 h-8 rounded-full flex items-center justify-center border-2 transition-all ${step >= s ? 'border-indigo-500 bg-indigo-500/20 text-indigo-300' : 'border-gray-600 text-gray-500'} ${s === step + 1 ? 'cursor-pointer hover:border-indigo-400' : ''}`}>
                                {s}
                            </div>
            ...
            <main className="flex-1 flex overflow-hidden">
                ...
                {step === 0 && (
                    <div className="w-full max-w-6xl mx-auto py-16 px-4 relative overflow-hidden">
                        ...
                        <div className="text-center mb-16 relative z-10 space-y-6">
                            {/* Premium Badge */}
                            <div className="inline-flex items-center gap-3 py-2 px-4 rounded-full bg-white/5 border border-white/10 backdrop-blur-sm shadow-xl animate-fade-in-up">
                                <span className="text-[10px] md:text-xs font-bold text-gray-400 tracking-wider">
                                    IN INDIA'S FIRST
                                </span>
                                <div className="w-px h-3 bg-white/20"></div>
                                <span className="text-[10px] md:text-xs font-medium text-gray-300 tracking-wide flex items-center gap-2">
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="relative inline-block">
                                    <h2 className="text-4xl md:text-6xl lg:text-7xl font-bold tracking-tight leading-tight">
                                        ...
                                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-violet-400 via-fuchsia-400 to-pink-400 drop-shadow-[0_0_15px_rgba(192,38,211,0.3)]">
                                            Automatically
                                        </span>
                                    </h2>
                                    {/* Glowing Underline */}
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-5 mb-12 max-w-4xl mx-auto relative z-10">
                            ...
                            <Link
                                ...
                                className="group relative bg-[#0d1220] rounded-2xl p-0.5 border border-white/10 hover:border-cyan-500/30 transition-all duration-300 hover:shadow-xl hover:shadow-cyan-900/20 cursor-pointer block"
                            >
                                ...
                                <div className="h-full bg-[#0a0f1a] rounded-[14px] p-5 md:p-6 flex flex-col relative overflow-hidden">
                                    <div className="mb-5">
                                        <h3 className="text-xl font-bold text-white mb-2">Pro</h3>
                                        <p className="text-sm text-gray-400">Perfect for getting started with Smart Writer</p>
                                    </div>

                                    <div className="flex-1 space-y-4 mb-6">
                                        <div className="flex items-start gap-3 group/item">
                                            <div className="w-6 h-6 rounded-md bg-cyan-500/20 text-cyan-400 flex items-center justify-center flex-shrink-0 mt-0.5 border border-cyan-500/30 group-hover/item:bg-cyan-500/30 transition-colors">
                                                <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7" /></svg>
                                            </div>
                                            <div>
                                                <span className="font-semibold text-white block text-sm">Smart Writing Tool</span>
                                                <p className="text-xs text-gray-300 mt-0.5 leading-relaxed">Generate chapters, outlines, and content effortlessly.</p>
                                            </div>
                                        </div>
                                        <div className="flex items-start gap-3 group/item">
                                            <div className="w-6 h-6 rounded-md bg-cyan-500/20 text-cyan-400 flex items-center justify-center flex-shrink-0 mt-0.5 border border-cyan-500/30 group-hover/item:bg-cyan-500/30 transition-colors">
                                            ...
                                            <div>
                                                <span className="font-semibold text-white block text-sm">Auto Formatting</span>
                                                <p className="text-xs text-gray-300 mt-0.5 leading-relaxed">Professional book layout and structure.</p>
                                            </div>
                                        </div>
                                        <div className="flex items-start gap-3 group/item">
                                            <div className="w-6 h-6 rounded-md bg-cyan-500/20 text-cyan-400 flex items-center justify-center flex-shrink-0 mt-0.5 border border-cyan-500/30 group-hover/item:bg-cyan-500/30 transition-colors">
                                            ...
                                            <div>
                                                <span className="font-semibold text-white block text-sm">Amazon-Ready Export</span>
                                                <p className="text-xs text-gray-300 mt-0.5 leading-relaxed">Export in KDP-ready formats.</p>
                                            </div>
                                        </div>
                                    </div>

                                    <div className="mt-auto">
                                        <div className="w-full py-2.5 bg-white/5 text-gray-300 font-semibold rounded-lg text-center border border-white/10 text-xs uppercase tracking-wider group-hover:bg-cyan-500/10 group-hover:border-cyan-500/30 group-hover:text-cyan-300 transition-all">
                                            View Pro Plans →
                                        </div>
                                    </div>
                                </div>
                            ...
                            >
                                ...
                                <div className="relative bg-[#0d1220] rounded-2xl h-full flex flex-col overflow-hidden">
                                    ...
                                    <div className="p-5 md:p-6 flex flex-col h-full bg-[#0a0f1a] rounded-2xl">
                                        <div className="mb-5">
                                            <h3 className="text-xl font-bold text-gray-400 mb-2">Premium</h3>
                                            <p className="text-sm text-gray-500">Complete suite for professional authors</p>
                                        </div>

                                        <div className="flex-1 space-y-4 mb-6">
                                            <div className="flex items-start gap-3">
                                                <div className="w-6 h-6 rounded-md bg-indigo-500/20 text-indigo-400 flex items-center justify-center flex-shrink-0 mt-0.5 border border-indigo-500/30">
                                                    <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" /></svg>
                                                </div>
                                                <div>
                                                    <span className="font-semibold text-white block text-sm">Advanced Smart Writer Engine</span>
                                                    <p className="text-xs text-gray-300 mt-0.5 leading-relaxed">Superior models for bestseller-quality prose.</p>
                                                </div>
                                            </div>

                                            <div className="flex items-start gap-3">
                                                <div className="w-6 h-6 rounded-md bg-cyan-500/20 text-cyan-400 flex items-center justify-center flex-shrink-0 mt-0.5 border border-cyan-500/30">
                                                    <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" /></svg>
                                                </div>
                                                <div>
                                                    <span className="font-semibold text-white block text-sm">Smart Writer Art Studio</span>
                                                    <p className="text-xs text-gray-300 mt-0.5 leading-relaxed">Stunning visuals for covers and headers.</p>
                                                </div>
                                            </div>
                                            ...
                                            <div className="flex items-start gap-3">
                                                ...
                                                <div>
                                                    <span className="font-semibold text-white block text-sm">Priority Support</span>
                                                    <p className="text-xs text-gray-300 mt-0.5 leading-relaxed">Get help when you need it most.</p>
                                                </div>
                                            </div>
                                        </div>

                                        <div className="mt-auto">
                                            <div className="w-full py-2.5 bg-gradient-to-r from-indigo-500/20 to-cyan-500/20 text-indigo-300 font-semibold rounded-lg text-center border border-indigo-500/30 text-xs uppercase tracking-wider group-hover:from-indigo-500/30 group-hover:to-cyan-500/30 transition-all">
                                                View Premium Plans →
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div className="w-full max-w-2xl mx-auto py-10 px-4 relative">
                            ...
                            <div className="relative z-10">
                                ...
                                <div className="text-center mb-6">
                                    <span className="inline-block py-1 px-3 rounded-full bg-indigo-500/20 border border-indigo-400/30 text-indigo-300 text-[10px] font-bold uppercase tracking-wider mb-3">
                                        Step 1 of 5
                                    </span>
                                    ...
                                    <div className="space-y-5">
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                            <div className="space-y-1.5">
                                                ...
                                                <input
                                                    ...
                                                    className="w-full bg-[#0a0f1a] border border-white/10 rounded-lg px-3 py-2.5 text-sm text-white placeholder-gray-500 focus:outline-none focus:border-indigo-400 focus:ring-1 focus:ring-indigo-400 transition"
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                            <div className="space-y-1.5">
                                                ...
                                                <select
                                                    ...
                                                    className="w-full bg-[#0a0f1a] border border-white/10 rounded-lg px-3 py-2.5 text-sm text-white focus:outline-none focus:border-indigo-400 focus:ring-1 focus:ring-indigo-400 transition appearance-none cursor-pointer"
                                                >
                                        ...
                                        <div className="space-y-1.5">
                                            <label className="block text-xs font-semibold text-gray-300 uppercase tracking-wider">
                                                Book Concept / Premise <span className="text-cyan-400">*</span>
                                            </label>
                                            <textarea
                                                value={initData.topic}
                                                onChange={e => setInitData({ ...initData, topic: e.target.value })}
                                                className="w-full bg-[#0a0f1a] border border-white/10 rounded-lg px-3 py-2.5 text-sm text-white placeholder-gray-500 focus:outline-none focus:border-indigo-400 focus:ring-1 focus:ring-indigo-400 transition h-20 resize-none"
                                        ...
                                        <div className="bg-[#0a0f1a] rounded-xl border border-white/10 p-4">
                                            <h4 className="text-[10px] font-bold text-gray-300 uppercase tracking-widest mb-4 flex items-center gap-1.5">
                                                <svg className="w-3 h-3 text-indigo-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 7h6m0 10v-3m-3 3h.01M9 17h.01M9 14h.01M12 14h.01M15 11h.01M12 11h.01M9 11h.01M7 21h10a2 2 0 002-2V5a2 2 0 00-2-2H7a2 2 0 00-2 2v14a2 2 0 002 2z" /></svg>
                                                Structure Settings
                                            </h4>
                                            {/* Logic: Mirror Guest Smart Writer Limits */}
                                            <div className="grid grid-cols-3 gap-4">
                                                <div className="space-y-1.5">
                                                    <label className="block text-[10px] font-bold text-gray-400">Chapters (Max 10)</label>
                                                    <input
                                                        type="number"
                                                        ...
                                                        className="w-full bg-[#070a10] border border-white/10 rounded-lg px-2 py-2 text-white text-center text-base font-bold focus:outline-none focus:border-indigo-400 transition"
                                                        min="1" max="10"
                                                    />
                                                </div>
                                                <div className="space-y-1.5">
                                                    <label className="block text-[10px] font-bold text-gray-400">Sub-chapters (Max 15)</label>
                                                    <input
                                                        type="number"
                                                ...
                                                <div className="space-y-1.5">
                                                    ...
                                                    <div className={`w-full bg-[#070a10] border border-white/10 rounded-lg px-2 py-2 text-center flex flex-col justify-center h-[50px] ${(() => {
                                                        const rangeParts = (initData.page_range || '80-100').split('-');
                                                        const maxPages = parseInt(rangeParts[1] || rangeParts[0] || 100);
                                                        ...
                                                        {(() => {
                                                            ...
                                                            if (totalSub === 0) return <span className="text-sm font-bold text-gray-500">0 Pages</span>;
                            ...
                            <div className="relative z-10">
                                ...
                                {chapters.length === 0 ? (
                                    <div className="bg-[#0d1220] rounded-2xl border border-white/10 p-6 md:p-8 shadow-xl text-center">
                                        ...
                                        <p className="text-sm text-gray-300 mb-6 max-w-sm mx-auto">Generate an outline with AI or manually create your own structure.</p>
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-xl mx-auto text-left">
                                            ...
                                            >
                                                <div className="w-8 h-8 rounded-lg bg-indigo-500/20 text-indigo-400 flex items-center justify-center mb-3 border border-indigo-500/30 group-hover:scale-110 transition-transform">
                                                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M13 10V3L4 14h7v7l9-11h-7z" /></svg>
                                                </div>
                                                <h4 className="font-semibold text-white text-sm mb-1">Smart Writer Mode</h4>
                                                <p className="text-xs text-gray-300 mb-4 flex-grow">Let Smart Writer create chapters based on your topic.</p>
                                            ...
                                            {/* Option B: Manual */}
                                            <div className="bg-[#0a0f1a] rounded-xl p-4 border border-white/10 hover:border-white/20 transition-all flex flex-col h-full">
                                                <div className="w-8 h-8 rounded-lg bg-white/5 text-gray-300 flex items-center justify-center mb-3 border border-white/10">
                                                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" /></svg>
                                                </div>
                                                <h4 className="font-semibold text-white text-sm mb-1">Manual Entry</h4>
                                                <p className="text-[10px] text-gray-300 mb-2">Type your {initData.chapter_count} chapters line by line.</p>
                                                <textarea
                                                    id="manual-chapters-input"
                                                    className="w-full bg-[#070a10] border border-white/10 rounded-lg px-3 py-2 text-white placeholder-gray-500 text-xs mb-3 flex-grow focus:outline-none focus:border-indigo-400 transition resize-none"
                                                    placeholder={`Chapter 1: Introduction\nChapter 2: Getting Started\n...`}
                                                    style={{ minHeight: '80px' }}
                                                ></textarea>
                                                <button
                                                    onClick={() => generateOutline('manual')}
                                                    className="w-full py-2.5 bg-white/10 hover:bg-white/20 text-white rounded-lg font-bold text-xs border border-white/10 transition-all"
                                                >
                                                    Save Manual List
                                                </button>
                                            </div>
                                    ...
                                    <div className="bg-[#0d1220] rounded-2xl border border-white/10 p-5 shadow-xl">
                                        ...
                                        <div className="space-y-2 mb-5 max-h-[45vh] overflow-y-auto pr-2">
                                            {chapters.map((chapter, i) => (
                                                <div key={chapter.id} className="bg-[#0a0f1a] p-3 rounded-lg border border-white/10 flex items-center gap-3 group hover:border-indigo-500/40 transition-all">
                                                    <span className="w-7 h-7 flex items-center justify-center bg-gradient-to-br from-indigo-500/30 to-transparent rounded-lg font-bold text-indigo-300 border border-indigo-500/30 text-xs">
                                                        {i + 1}
                                                    </span>
                ...
                {/* Step 3: Sub-Chapters (Structure) - Premium Dark Theme */}
                {
                    step === 3 && (
                        <div className="flex w-full h-full">
                            {/* Sidebar Chapters */}
                            <div className="w-64 bg-[#0a0f1a] border-r border-white/10 overflow-y-auto flex flex-col">
                                <div className="p-3 border-b border-white/10">
                                    <span className="inline-block py-0.5 px-2 rounded-md bg-indigo-500/20 border border-indigo-400/30 text-indigo-300 text-[9px] font-bold uppercase tracking-wider mb-1">
                                        Step 3 of 5
                                    </span>
                                    <h3 className="font-bold text-white text-sm">Chapter Structure</h3>
                                    <p className="text-[10px] text-gray-300">Select a chapter to generate sub-sections</p>
                                </div>
                                <div className="flex-1 overflow-y-auto">
                                    {chapters.map((chapter, i) => (
                                        <div
                                            ...
                                            className={`p-3 border-b border-white/5 cursor-pointer hover:bg-white/5 transition ${activeChapterId === chapter.id ? 'bg-indigo-500/15 border-l-4 border-l-indigo-400' : ''}`}
                                        >
                                ...
                                {activeChapterId && (
                                    <div className="max-w-xl mx-auto relative z-10">
                                        <h2 className="text-lg font-bold mb-1 text-white">
                                            Structure for: <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 to-cyan-400">{chapters.find(c => c.id === activeChapterId)?.title}</span>
                                        </h2>
                                        <p className="text-gray-300 text-xs mb-5">Define the sub-sections that will make up this chapter.</p>
                                        ...
                                        {chapters.find(c => c.id === activeChapterId)?.sections && chapters.find(c => c.id === activeChapterId)?.sections.length > 0 ? (
                                            <div className="space-y-2">
                                                {chapters.find(c => c.id === activeChapterId).sections.map((section, idx) => (
                                                    <div key={section.id} className="bg-[#0d1220] p-3 rounded-lg border border-white/10 flex items-center gap-3 group hover:border-indigo-500/40 transition-all">
                                                        <span className="w-6 h-6 flex items-center justify-center bg-indigo-500/20 rounded-md text-indigo-300 text-xs font-bold border border-indigo-500/30">{idx + 1}</span>
                                                        <span className="text-white text-sm font-medium">{section.title}</span>
                                                    </div>
                                                ))}
                                            </div>
                                        ) : (
                                            <div className="bg-[#0d1220] rounded-xl border border-white/10 p-6 text-center">
                                                ...
                                                <h3 className="font-bold text-white text-base mb-1">No sections yet</h3>
                                                <p className="text-gray-300 mb-5 text-xs max-w-xs mx-auto">Generate sub-headings for this chapter to organize the content.</p>
                                                <div className="flex flex-col gap-3 max-w-sm mx-auto">
                                                    ...
                                                    <div className="relative flex py-2 items-center">
                                                        ...
                                                        <span className="flex-shrink-0 mx-3 text-gray-400 text-[10px] uppercase tracking-wider">Or manually (max {initData.sub_chapter_count})</span>
                                                        <div className="flex-grow border-t border-white/10"></div>
                                                    </div>

                                                    <textarea
                                                        id={`manual-input-${activeChapterId}`}
                                                        className="w-full bg-[#0a0f1a] border border-white/10 rounded-lg px-3 py-2 text-white placeholder-gray-500 text-xs focus:outline-none focus:border-indigo-400 transition h-24 resize-none"
                                                        placeholder={`1. First sub-heading\n2. Second sub-heading\n...`}
                                                    ></textarea>

                                                    <button
                                                        onClick={() => saveManualStructure(activeChapterId)}
                                                        className="w-full py-2 bg-white/10 hover:bg-white/20 text-white rounded-lg font-bold text-xs border border-white/10 transition-all"
                                                    >
                ...
                {/* Step 4: WRITING - Premium Dark Theme */}
                {
                    step === 4 && (
                        <div className="flex w-full h-full">
                            {/* Sidebar Navigation */}
                            <div className="w-60 bg-[#0a0f1a] border-r border-white/10 flex flex-col">
                                <div className="p-3 border-b border-white/10">
                                    <span className="inline-block py-0.5 px-2 rounded-md bg-indigo-500/20 border border-indigo-400/30 text-indigo-300 text-[9px] font-bold uppercase tracking-wider mb-1">
                                        Step 4 of 5
                                    </span>
                                ...
                                <div className="flex-1 overflow-y-auto custom-scrollbar">
                                    {chapters.map((chapter) => (
                                        <div key={chapter.id}>
                                            <div className="px-3 py-2 bg-[#070a10] text-[10px] font-bold text-gray-300 uppercase tracking-wider sticky top-0 border-b border-white/5">
                                                {chapter.title}
                                            </div>
                                            {chapter.sections?.map(section => (
                                                <button
                                                    ...
                                                    className={`w-full text-left px-4 py-2 text-xs border-b border-white/5 hover:bg-white/5 transition ${activeSection?.id === section.id ? 'bg-indigo-500/15 text-white border-l-4 border-l-indigo-400' : 'text-gray-300'}`}
                                                >
                                ...
                                {activeSection ? (
                                    <div className="flex-1 flex flex-col h-full">
                                        <div className="h-12 border-b border-white/10 flex items-center justify-between px-5 bg-[#0a0f1a]">
                                            ...
                                            <div className="flex gap-3 items-center">
                                                ...
                                                {!activeSection.content ? (
                                                    ...
                                                    <div className="px-3 py-1.5 bg-emerald-500/20 text-emerald-300 font-bold rounded-lg border border-emerald-500/30 text-xs flex items-center gap-1.5">
                                        ...
                                        {book.ai_plan_type === 'premium' ? (
                                            <div className="h-10 border-b border-white/10 flex items-center px-5 bg-[#0d1220]">
                                                <button
                                                    ...
                                                    className={`text-[10px] font-bold uppercase tracking-wider flex items-center gap-1.5 transition-colors ${isGeneratingImage ? 'text-gray-500 cursor-not-allowed' : 'text-indigo-400 hover:text-indigo-300'}`}
                                                >
                                                    {isGeneratingImage ? (
                                                        <>
                                                ...
                                                {imageCredits.limit > 0 && (
                                                    <>
                                                        ...
                                                        <div className="flex items-center gap-1.5 text-[10px] uppercase font-bold tracking-wider text-gray-400">
                                                            <span>Credits:</span>
                                                            <span className={imageCredits.used >= imageCredits.limit ? 'text-red-400' : 'text-emerald-400'}>
                                        ...
                                        <div className="flex-1 p-6 overflow-y-auto custom-scrollbar relative">
                                            ...
                                            <div className="max-w-2xl mx-auto bg-[#0d1220] min-h-[600px] shadow-xl border border-white/10 rounded-xl p-8 relative z-10">
                                                {activeSection.image_url && (
                                                    <div className="mb-6 p-2 border border-white/10 rounded-lg bg-[#0a0f1a] text-center">
                                                ...
                                                {activeSection.content ? (
                                                    ...
                                                    <div className="flex flex-col items-center justify-center h-full text-center py-16">
                                                        ...
                                                        <p className="text-gray-300 text-sm font-medium max-w-xs">Click "Write This Section" to generate content.</p>
                                                    </div>
                                                )}
                                            </div>
                                        </div>
                                    ...
                                    <div className="flex-1 flex items-center justify-center">
                                        <div className="text-center">
                                            <div className="w-16 h-16 bg-[#0d1220] rounded-xl flex items-center justify-center mx-auto mb-4 border border-white/10">
                                                <svg className="w-7 h-7 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" /></svg>
                                            </div>
                                            <p className="text-base font-medium text-gray-400">← Select a section to start writing</p>
                                        </div>
                                    </div>
                                )}
                            </div>
                    ...
                    step === 5 && (
                        <div className="w-full max-w-2xl mx-auto py-10 px-4 relative">
                            ...
                            <div className="relative z-10">
                                {/* Header */}
                                <div className="text-center mb-6">
                                    <span className="inline-block py-1 px-3 rounded-full bg-emerald-500/20 border border-emerald-400/30 text-emerald-300 text-[10px] font-bold uppercase tracking-wider mb-3">
                                ...
                                <div className="bg-[#0d1220] rounded-2xl border border-white/10 p-6 md:p-8 shadow-xl text-center">
                                    ...
                                    <div className="space-y-3 max-w-sm mx-auto">
                                        {/* DOCX Download */}
                                        <div className="p-3 bg-[#0a0f1a] rounded-xl border border-white/10 flex items-center justify-between hover:border-indigo-500/40 transition-all group">
                                            <div className="flex items-center gap-3">
                                                <div className="w-9 h-9 bg-blue-500/20 rounded-lg flex items-center justify-center text-blue-400 border border-blue-500/30">
                                                ...
                                                <div className="text-left">
                                                    <div className="font-semibold text-sm text-white">Microsoft Word (.docx)</div>
                                                    <div className="text-[10px] text-gray-400">Standard manuscript format</div>
                                                </div>
                                            </div>
                                            <a href={route('ai-studio.download', { book: book.id, format: 'docx' })} className="px-3 py-1.5 bg-white/10 hover:bg-white/20 border border-white/10 rounded-lg text-xs font-bold text-white transition-all">
                                                Download
                                            </a>
                                        </div>
                                        ...
                                        <div className="p-3 bg-[#0a0f1a] rounded-xl border border-white/10 flex items-center justify-between hover:border-indigo-500/40 transition-all group">
                                            <div className="flex items-center gap-3">
                                                ...
                                                <div className="text-left">
                                                    <div className="font-semibold text-sm text-white">PDF Document (.pdf)</div>
                                                    <div className="text-[10px] text-gray-400">Universal format, print-ready</div>
                                                </div>
                                            </div>
                                            <a href={route('ai-studio.download', { book: book.id, format: 'pdf' })} className="px-3 py-1.5 bg-white/10 hover:bg-white/20 border border-white/10 rounded-lg text-xs font-bold text-white transition-all">
                                                Download
                                            </a>
                                        </div>
                                    </div>
                                    ...
                                    <div className="mt-8 pt-6 border-t border-white/10">
                                        <h3 className="text-sm font-bold text-white mb-1">What's Next?</h3>
                                        <p className="text-gray-300 text-xs mb-4">Fine-tune fonts, layout, and add images in the formatting editor.</p>
                                        <Link
                                        ...
                                        <div className="mt-4 pt-4 border-t border-white/5">
                                            <button
                                                onClick={() => setStep(4)}
                                                className="text-xs text-indigo-400 hover:text-indigo-300 underline transition-colors mr-6"
                                            >
                                                ← Back to Editor
                                            </button>
                                            <button
                    ...
                    <div className="fixed inset-0 bg-black/70 backdrop-blur-sm flex items-center justify-center z-[100] p-4">
                        <div className="bg-[#0d1220] rounded-2xl border border-white/10 w-full max-w-md overflow-hidden shadow-2xl">
                            ...
                            <div className="p-4 space-y-4">
                                <p className="text-sm text-gray-300">
                                    Generate an AI illustration for: <span className="text-white font-semibold">{activeSection?.title}</span>
                                </p>
                                ...
                                <div className="grid grid-cols-2 gap-3">
                                    <button
                                        ...
                                        className={`p-4 rounded-xl border text-center transition-all ${imagePromptMode === 'auto' ? 'border-indigo-500 bg-indigo-500/20' : 'border-white/10 hover:border-white/20 bg-white/5'}`}
                                    >
                                        <span className="text-2xl mb-2 block">🤖</span>
                                        <span className={`text-sm font-bold block ${imagePromptMode === 'auto' ? 'text-white' : 'text-gray-300'}`}>Auto (AI)</span>
                                        <span className="text-[10px] text-gray-400 mt-1 block">Based on content</span>
                                    </button>
                                    <button
                                        onClick={() => setImagePromptMode('custom')}
                                        className={`p-4 rounded-xl border text-center transition-all ${imagePromptMode === 'custom' ? 'border-cyan-500 bg-cyan-500/20' : 'border-white/10 hover:border-white/20 bg-white/5'}`}
                                    >
                                        <span className="text-2xl mb-2 block">✏️</span>
                                        <span className={`text-sm font-bold block ${imagePromptMode === 'custom' ? 'text-white' : 'text-gray-300'}`}>Custom</span>
                                        <span className="text-[10px] text-gray-400 mt-1 block">Your own prompt</span>
                                    </button>
                                </div>
                                ...
                                {imagePromptMode === 'custom' && (
                                    <div className="space-y-2">
                                        ...
                                        <textarea
                                            ...
                                            className="w-full bg-[#0a0f1a] border border-white/10 rounded-lg px-3 py-2.5 text-white text-sm placeholder-gray-500 focus:outline-none focus:border-cyan-400 transition resize-none h-24"
                                        />
                            ...
                            <div className="p-4 border-t border-white/10 flex gap-3">
                                <button
                                    onClick={() => setShowImagePromptModal(false)}
                                    className="flex-1 py-2.5 bg-white/5 text-gray-300 font-semibold rounded-lg text-sm border border-white/10 hover:bg-white/10 transition-colors"
                                >
                                    Cancel
                                </button>
                                <button
