                    ...
                    <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-8">
                        ...
                        <div className="bg-paper rounded-2xl border border-linen p-6">
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="bg-paper rounded-xl p-4 border border-linen">
                                    ...
                                    <h3 className="text-lg font-bold text-ink">{serviceNames[serviceType]}</h3>
                                </div>
                                ...
                                <div className="space-y-3 pt-4 border-t border-linen">
                                    <h4 className="text-sm font-bold text-ink-soft uppercase tracking-wider">What's Included</h4>
                                ...
                                {/* What Happens Next? */}
                                <div className="pt-4 border-t border-linen">
                                    <h4 className="text-sm font-bold text-ink-soft uppercase tracking-wider mb-3">What Happens Next?</h4>
                                    <div className="space-y-2">
                                        {requiresUpload ? (
                                            <>
                                                <div className="flex items-start gap-3">
                                                    ...
                                                    <span className="text-sm text-ink-soft">Upload your manuscript (DOCX/PDF)</span>
                                                </div>
                                                <div className="flex items-start gap-3">
                                                    ...
                                                    <span className="text-sm text-umber">Our team formats your book</span>
                                                </div>
                                                <div className="flex items-start gap-3">
                                                    ...
                                                    <span className="text-sm text-umber">Download your formatted file</span>
                                                </div>
                                            </>
                                        ) : (
                                            <>
                                                <div className="flex items-start gap-3">
                                                    ...
                                                    <span className="text-sm text-ink-soft">Our team will contact you within 24hrs</span>
                                                </div>
                                                <div className="flex items-start gap-3">
                                                    ...
                                                    <span className="text-sm text-umber">Discuss your cover vision & requirements</span>
                                                </div>
                                                <div className="flex items-start gap-3">
                                                    ...
                                                    <span className="text-sm text-umber">Receive your custom cover design</span>
                                                </div>
                                            </>
                                        )}
                                    </div>
                        ...
                        <div className="bg-paper rounded-2xl border border-linen p-6">
                            ...
                            <div className="bg-indigo-500/10 border border-indigo-500/20 rounded-xl p-4 mb-6 flex items-start gap-3">
                                ...
                                <div>
                                    <h4 className="font-bold text-ink text-sm mb-1">Redirecting to PhonePe</h4>
