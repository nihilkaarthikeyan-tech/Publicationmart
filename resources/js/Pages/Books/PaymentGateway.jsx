                            ...
                            <div className="space-y-4">
                                ...
                                <div className="bg-paper rounded-xl p-4 border border-linen">
                                    <div className="flex items-center justify-between mb-2">
                                        <span className="text-umber text-sm">Selected Plan</span>
                                    ...
                                    <h3 className="text-lg font-bold text-ink capitalize">{plan}</h3>
                                </div>

                                {/* Book Info */}
                                <div className="bg-paper rounded-xl p-4 border border-linen">
                                    <div className="text-umber text-sm mb-2">For Book</div>
                                    <h3 className="text-ink font-medium">{book.title || 'Untitled Book'}</h3>
                                </div>

                                {/* Plan Details */}
                                <div className="space-y-3 pt-4 border-t border-linen">
                                    <div className="flex justify-between items-center">
                                        <span className="text-umber text-sm">Number of Books</span>
                                        <span className="text-ink font-semibold">{planDetails.books}</span>
                                    </div>
                                    <div className="flex justify-between items-center">
                                        <span className="text-umber text-sm">Word Credits</span>
                                        <span className="text-ink font-semibold">{planDetails.words}</span>
                                    </div>
                                    <div className="flex justify-between items-center">
                                        <span className="text-umber text-sm">AI Features</span>
                                ...
                                <div className="pt-4 border-t border-linen">
                                    <div className="flex justify-between items-center">
                                        ...
                                        <span className="text-2xl font-bold text-oxblood">
                                            {planDetails.currency}{planDetails.price}
                                        </span>
                                    </div>
                                    <p className="text-xs text-umber mt-1">One-time payment � No recurring fees</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="bg-paper rounded-2xl border border-linen p-6">
                            ...
                            <div className="bg-indigo-500/10 border border-indigo-500/20 rounded-xl p-4 mb-6">
                                <div className="flex gap-3">
                                    ...
                                    <div>
                                        <h3 className="font-semibold text-ink text-sm mb-1">Secure Payment via PhonePe</h3>
                            ...
                            <div className="flex justify-center gap-4 mb-8 opacity-50 grayscale hover:grayscale-0 transition-all duration-500">
                                <span className="text-ink text-xs border border-linen px-2 py-1 rounded">UPI</span>
                                <span className="text-ink text-xs border border-linen px-2 py-1 rounded">Visa</span>
                                <span className="text-ink text-xs border border-linen px-2 py-1 rounded">MasterCard</span>
                                <span className="text-ink text-xs border border-linen px-2 py-1 rounded">RuPay</span>
                                <span className="text-ink text-xs border border-linen px-2 py-1 rounded">NetBanking</span>
                            </div>
                            ...
                            {/* Security Badge */}
                            <div className="mt-4 flex items-center justify-center gap-2 text-umber">
