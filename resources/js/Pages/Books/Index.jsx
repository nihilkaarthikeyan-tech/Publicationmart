            ...
            <div className="min-h-screen bg-parchment text-ink font-sans selection:bg-indigo-500/30">
                ...
                <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
                    ...
                    <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-10">
                        <div>
                            <h1 className="text-3xl font-black tracking-tight text-ink mb-2">My Publications</h1>
                            <p className="text-umber">Manage your books, track status, and update details.</p>
                        </div>
                        <div className="flex items-center gap-3">
                            <Link href={route('dashboard')} className="px-5 py-2.5 bg-paper hover:bg-paper border border-linen text-ink-soft rounded-xl transition-all text-sm font-bold flex items-center gap-2">
                            ...
                            {filteredBooks.length > 0 ? (
                                    ...
                                    <div key={book.id} className="md:grid md:grid-cols-12 md:gap-4 p-5 hover:bg-white/[0.02] transition-colors items-center group">
                                        ...
                                        <div className="col-span-5 mb-4 md:mb-0">
                                            <div className="flex items-center gap-4">
                                                <div className="w-12 h-16 bg-paper rounded-lg overflow-hidden flex-shrink-0 border border-linen">
                                                ...
                                                <div className="min-w-0">
                                                    <h4 className="text-ink font-bold text-base md:text-lg leading-tight truncate group-hover:text-indigo-700 transition-colors" title={book.title}>
                                                        {book.title}
                                                    </h4>
                                                    <p className="text-umber text-sm truncate">by {book.author_name}</p>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div className="col-span-2 text-center hidden md:block">
                                            <div className="text-xs text-umber mb-1">Progress</div>
                                            <div className="w-full bg-paper h-1.5 rounded-full max-w-[80px] mx-auto overflow-hidden">
                                                <div
                                                    className="bg-indigo-500 h-full rounded-full transition-all duration-500"
                                                    style={{ width: `${(book.step_completed / 4) * 100}%` }}
                                                ></div>
                                            </div>
                                            <div className="text-[10px] font-bold text-umber mt-1 uppercase">{book.step_completed}/4 Steps</div>
                                        </div>
                                        ...
                                        <div className="col-span-3 flex items-center justify-end gap-3">
                                            <Link
                                                ...
                                                className="px-4 py-2 bg-paper hover:bg-vellum text-ink text-xs font-bold rounded-xl transition-all border border-linen flex items-center gap-2"
                                            >
                                            ...
                                            <button
                                                ...
                                                className="p-2.5 text-umber hover:text-red-700 hover:bg-red-500/10 rounded-xl transition-all"
                                ...
                                <div className="p-20 text-center flex flex-col items-center justify-center">
                                    <div className="w-20 h-20 bg-paper rounded-full flex items-center justify-center mb-6">
                                        <svg className="w-10 h-10 text-umber" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" /></svg>
                                    </div>
                                    <h3 className="text-ink font-black text-xl mb-2">No publications yet</h3>
                                    <p className="text-umber mb-8 max-w-sm">Ready to share your story with the world? Start your first publication now.</p>
