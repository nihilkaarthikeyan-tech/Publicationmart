            ...
            <div className="min-h-screen bg-parchment">
                ...
                <main className="max-w-7xl mx-auto py-16 px-4 relative">
                    ...
                    <div className="text-center mb-12 relative z-10">
                        ...
                        <p className="text-umber max-w-xl mx-auto mt-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 relative z-10">
                        {plans.map((plan) => (
                            ...
                            >
                                ...
                                <div className={`relative bg-paper rounded-2xl h-full flex flex-col overflow-hidden border ${plan.popular ? 'border-indigo-500/50' : 'border-linen hover:border-taupe'} transition-all duration-300`}>
                                    <div className="p-8 flex flex-col h-full bg-paper">
                                        {/* Plan Name */}
                                        ...
                                        <div className="flex items-center gap-2 mb-1 mt-4">
                                            <span className="text-umber line-through text-sm">₹{plan.originalPrice}</span>
                                            <span className="text-4xl font-bold text-ink">₹{plan.discountedPrice}</span>
                                        </div>
                                        ...
                                        <div className="flex items-center gap-3 mb-6 bg-paper py-2 px-3 rounded-lg border border-linen">
                                            ...
                                            <span className="text-ink-soft font-semibold text-sm">{plan.pages}</span>
                                        </div>
                                        ...
                                        <div className="flex-1 space-y-4 mb-8">
                                            {plan.features.map((feature, idx) => (
                                                <div key={idx} className="flex items-center gap-3">
                                                    ...
                                                    <span className="text-sm text-umber font-medium">{feature}</span>
                                                </div>
                                            ))}
                                        </div>
                                        ...
                                        <button
                                            ...
                                            className={`w-full py-4 text-xs font-bold rounded-lg tracking-widest uppercase transition-all duration-300 ${plan.popular
                                                ? 'bg-gradient-to-r from-cyan-500 to-blue-500 hover:from-cyan-400 hover:to-blue-400 text-ink shadow-lg shadow-cyan-500/20'
                                                : 'bg-paper hover:bg-vellum text-ink border border-linen'
                                                }`}
                                        >
                                            Start Writing
                                        </button>
