                ...
                <header className="bg-[#0d1220]/90 backdrop-blur-md border-b border-[#d8d1c1] sticky top-0 z-50">
                    ...
                    <div className="h-12 border-t border-[#d8d1c1] flex items-center justify-between px-6 bg-[#0a0f1a]/80">
                        <div className="flex items-center gap-2 pl-20 md:pl-24">
                            ...
                            <span className="text-[10px] bg-indigo-500/20 text-indigo-700 px-2 py-0.5 rounded-full border border-indigo-400/30 font-bold uppercase tracking-wider">Pro Plans</span>
                        </div>
                    </div>
                </header>
                ...
                <main className="max-w-7xl mx-auto py-16 px-4 relative">
                    ...
                    <div className="text-center mb-12 relative z-10">
                        <div className="flex items-center justify-center gap-2 mb-4">
                            ...
                            <span className="text-[#635c4e] text-xs">| AI-Powered Book Writing & Publishing Platform 🟢</span>
                        </div>
                        <h1 className="text-4xl md:text-6xl font-bold text-[#17150f] mb-4 tracking-tight leading-tight">
                        ...
                        <p className="text-[#635c4e] max-w-xl mx-auto mt-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 relative z-10">
                        {plans.map((plan) => (
                            ...
                            >
                                ...
                                <div className={`relative bg-[#faf8f3] rounded-2xl h-full flex flex-col overflow-hidden border ${plan.popular ? 'border-indigo-500/50' : 'border-[#d8d1c1] hover:border-[#7c7364]'} transition-all duration-300`}>
                                    <div className="p-8 flex flex-col h-full bg-[#faf8f3]">
                                        {/* Plan Name */}
                                        <h3 className="text-xl font-bold text-[#17150f] mb-1">
                                            {plan.name}
                                        </h3>

                                        {/* Pricing */}
                                        <div className="flex items-center gap-2 mb-1 mt-4">
                                            <span className="text-[#635c4e] line-through text-sm">₹{plan.originalPrice}</span>
                                            <span className="text-4xl font-bold text-[#17150f]">₹{plan.discountedPrice}</span>
                                        </div>
                                        ...
                                        <div className="flex items-center gap-3 mb-6 bg-[#faf8f3] py-2 px-3 rounded-lg border border-[#d8d1c1]">
                                            <div className="w-5 h-5 rounded-full bg-indigo-500/20 flex items-center justify-center text-indigo-700">
                                                <svg className="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" /></svg>
                                            </div>
                                            <span className="text-[#4b443a] font-semibold text-sm">{plan.pages}</span>
                                        </div>
                                        ...
                                        <div className="flex-1 space-y-4 mb-8">
                                            {plan.features.map((feature, idx) => (
                                                <div key={idx} className="flex items-center gap-3">
                                                    <div className="flex-shrink-0 w-5 h-5 rounded-full bg-[#faf8f3] flex items-center justify-center border border-gray-700">
                                                        <svg className="w-3 h-3 text-[#635c4e]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7" />
                                                        </svg>
                                                    </div>
                                                    <span className="text-sm text-[#635c4e] font-medium">{feature}</span>
                                                </div>
                                            ))}
                                        </div>
                                        ...
                                        <button
                                            ...
                                            className={`w-full py-4 text-xs font-bold rounded-lg tracking-widest uppercase transition-all duration-300 ${plan.popular
                                                ? 'bg-gradient-to-r from-cyan-500 to-blue-500 hover:from-cyan-400 hover:to-blue-400 text-[#17150f] shadow-lg shadow-cyan-500/20'
                                                : 'bg-[#faf8f3] hover:bg-[#e7e1d4] text-[#17150f] border border-[#d8d1c1]'
                                                }`}
                                        >
                                            Start Writing
                                        </button>
