        ...
        <div className="min-h-screen bg-parchment text-ink font-sans selection:bg-indigo-500/30">
            ...
            <div className="pt-32 pb-20 max-w-4xl mx-auto px-6">
                ...
                <div className="prose prose-invert prose-lg max-w-none text-umber">
                    <p className="lead text-xl text-ink">Last updated: January 12, 2026</p>
                    ...
                    <h2 className="text-ink mt-10 mb-4 text-2xl font-bold">Log Files</h2>
                    <p>
                    ...
                    <h2 className="text-ink mt-10 mb-4 text-2xl font-bold">Privacy Policies</h2>
                    <p>
                    ...
                    <h2 className="text-ink mt-10 mb-4 text-2xl font-bold">Third Party Privacy Policies</h2>
                    <p>
                    ...
                    <h2 className="text-ink mt-10 mb-4 text-2xl font-bold">Children's Information</h2>
                    <p>
                    ...
                    <h2 className="text-ink mt-10 mb-4 text-2xl font-bold">Consent</h2>
                    <p>
