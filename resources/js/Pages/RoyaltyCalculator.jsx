    ...
    return (
        <div className="min-h-screen bg-[#17150f] text-white selection:bg-indigo-500 selection:text-white">
            ...
            <div className="pt-32 pb-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
                ...
                <div className="max-w-2xl mx-auto bg-[#0a0a0c] rounded-3xl border border-white/10 p-8 md:p-12 shadow-2xl relative overflow-hidden animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
                    {/* Glow Effect */}
                    <div className="absolute top-0 right-0 w-64 h-64 bg-indigo-600/10 rounded-full blur-[80px] pointer-events-none" />

                    {/* Format Toggle */}
                    <div className="space-y-2 mb-10">
                        <label className="text-sm font-medium text-gray-400">Book Format</label>
