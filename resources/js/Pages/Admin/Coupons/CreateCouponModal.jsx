        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/40 backdrop-blur-sm animate-fade-in">
            <div className="bg-white rounded-xl w-full max-w-md shadow-2xl overflow-hidden animate-scale-in border border-gray-100">
                ...
                <form onSubmit={handleSubmit} className="p-5 space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <div className="space-y-1.5">
                            <label className="text-[11px] font-black uppercase tracking-wider text-gray-500 ml-1">Code</label>
                        ...
                        <div className="space-y-1.5">
                            <label className="text-[11px] font-black uppercase tracking-wider text-gray-500 ml-1">Discount %</label>
                            <div className="relative">
                                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                        ...
                        <div className="col-span-2 space-y-1.5">
                            <label className="text-[11px] font-black uppercase tracking-wider text-gray-500 ml-1">Min Order Value (Optional)</label>
                            <div className="relative">
                                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                    <span className="text-gray-400 text-xs font-bold">₹</span>
                                </div>
                ...
                <div className="bg-gray-50 p-4 border-t border-gray-100 max-h-[35vh] overflow-y-auto custom-scrollbar">
                    <h4 className="text-[11px] text-gray-400 font-black uppercase tracking-widest mb-3 flex items-center gap-2">
                    ...
                    {coupons.length > 0 ? (
                                ...
                                <div key={coupon.id} className="bg-white border border-gray-100 rounded-lg p-3 flex items-center justify-between shadow-sm hover:border-indigo-100 transition-all">
                                    ...
                                    <div className="flex items-center gap-2">
                                        <div className="text-right mr-1">
                                            ...
                                            <p className="text-[9px] text-gray-400 uppercase font-bold tracking-tight">Uses</p>
                                        </div>
                        ...
                        <div className="text-center py-6 text-gray-400 italic text-xs">No active coupons.</div>
                    )}
                </div>
            </div>
        </div>
