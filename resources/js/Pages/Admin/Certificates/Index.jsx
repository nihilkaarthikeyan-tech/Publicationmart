            ...
            <div className="min-h-screen bg-gray-100 dark:bg-gray-900 py-12">
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
                    ...
                    <div className="flex justify-between items-center mb-6">
                        <div>
                            <h2 className="font-semibold text-2xl text-gray-800 dark:text-gray-200 leading-tight">Certificate Manager</h2>
                    ...
                    {/* Issue Form */}
                    {showForm && (
                        <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg border border-indigo-500/30 animate-in fade-in slide-in-from-top-4">
                            <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-4">Issue Digital Certificate</h3>
                            <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <input
                                        type="file"
                                        className="w-full mt-1 text-gray-400 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-indigo-50 file:text-indigo-700 hover:file:bg-indigo-100 dark:file:bg-gray-700 dark:file:text-gray-300"
                    ...
                    <div className="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                        <div className="p-6">
                            <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-4">Issued Certificates</h3>

                            {certificates.length === 0 ? (
                                <p className="text-gray-500 text-center py-10">No certificates issued yet.</p>
                            ) : (
                                    ...
                                    <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                                        ...
                                        <tbody className="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                                            {certificates.map((cert) => (
                                                <tr key={cert.id} className="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition">
                                                    <td className="px-6 py-4 whitespace-nowrap">
                                                        <div className="text-sm font-medium text-gray-900 dark:text-white">{cert.recipient_name}</div>
