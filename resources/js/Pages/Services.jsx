        ...
        <div className="min-h-screen bg-parchment text-ink font-sans selection:bg-indigo-500/30">
            ...
            <div className="relative pt-32 pb-20 overflow-hidden">
                ...
                <div className="max-w-7xl mx-auto px-6 relative z-10 text-center">
                    <span className="inline-block py-1 px-3 rounded-full bg-indigo-500/10 border border-indigo-500/20 text-indigo-700 text-xs font-bold uppercase tracking-widest mb-6">
                        World-Class Solutions
                    </span>
                    <h1 className="text-5xl md:text-7xl font-black mb-6 tracking-tight">
                        Professional <span className=" text-oxblood">Publishing Services</span>
                    </h1>
                    <p className="text-xl text-umber max-w-2xl mx-auto leading-relaxed">
            ...
            <div className="py-20 bg-parchment">
                <div className="max-w-7xl mx-auto px-6">
                    <div className="grid md:grid-cols-3 gap-8">
                        ...
                        <div className="bg-parchment rounded-2xl p-8 border border-linen hover:border-taupe transition-all group">
                            ...
                            <Link href="/contact" className="inline-flex items-center text-indigo-700 font-bold hover:text-indigo-700 transition-colors">
                                Get a Quote <span className="ml-2">→</span>
                            </Link>
                        </div>

                        {/* Service 2: Premium Book Design */}
                        <div className="bg-parchment rounded-2xl p-8 border border-linen hover:border-cyan-500/30 transition-all group">
                        ...
                        <div className="bg-parchment rounded-2xl p-8 border border-linen hover:border-taupe transition-all group">
                            ...
                            <Link href="/contact" className="inline-flex items-center text-purple-700 font-bold hover:text-purple-700 transition-colors">
