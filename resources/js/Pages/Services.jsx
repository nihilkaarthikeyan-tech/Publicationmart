...
export default function Services() {
    return (
        <div className="min-h-screen bg-[#f0ece3] text-[#17150f] font-sans selection:bg-indigo-500/30">
            ...
            {/* Services Grid */}
            <div className="py-20 bg-[#f0ece3]">
                <div className="max-w-7xl mx-auto px-6">
                    <div className="grid md:grid-cols-3 gap-8">
                        {/* Service 1: Professional Editing */}
                        <div className="bg-[#f0ece3] rounded-2xl p-8 border border-[#d8d1c1] hover:border-[#7c7364] transition-all group">
                            ...
                            <ul className="space-y-3 mb-8">
                                <li className="flex items-center gap-2 text-sm text-[#4b443a]">
            ...
            <div className="py-24 relative overflow-hidden">
                ...
                <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
                    ...
                    <p className="text-xl text-[#635c4e] mb-8">
