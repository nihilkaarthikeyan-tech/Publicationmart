        ...
        <div className="min-h-screen bg-[#f0ece3] text-[#17150f] font-sans selection:bg-indigo-500/30">
            ...
            <div className="pt-32 pb-20 max-w-4xl mx-auto px-6">
                ...
                <div className="prose prose-invert prose-lg max-w-none text-[#635c4e]">
                    ...
                    <h3 className="text-indigo-700 mt-6 mb-2 text-lg font-semibold">Grant of Rights</h3>
                    <p>
                    ...
                    <h3 className="text-indigo-700 mt-6 mb-2 text-lg font-semibold">Indemnity</h3>
                    <p>
                    ...
                    <h3 className="text-indigo-700 mt-6 mb-2 text-lg font-semibold">Payment Cycle</h3>
                    <p>
                    ...
                    <h3 className="text-indigo-700 mt-6 mb-2 text-lg font-semibold">Pricing</h3>
                    <p>
                    ...
                    <h3 className="text-indigo-700 mt-6 mb-2 text-lg font-semibold">ISBN</h3>
                    <p>
                        Publication Mart provides an ISBN under its own imprint unless the author provides their own.
                    </p>

                    <h3 className="text-indigo-700 mt-6 mb-2 text-lg font-semibold">Timeline</h3>
                    <p>
                    ...
                    <h3 className="text-indigo-700 mt-6 mb-2 text-lg font-semibold">In-Progress Refund</h3>
                    <p>
                    ...
                    <h3 className="text-indigo-700 mt-6 mb-2 text-lg font-semibold">Post-Publication</h3>
                    <p>
                    ...
                    <h3 className="text-indigo-700 mt-6 mb-2 text-lg font-semibold">Availability</h3>
                    <p>
                    ...
                    <h3 className="text-indigo-700 mt-6 mb-2 text-lg font-semibold">Withdrawal</h3>
                    <p>
