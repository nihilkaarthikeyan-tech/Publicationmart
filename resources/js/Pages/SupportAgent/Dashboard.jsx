...
const s = {
    ...
    filterBtn:    { padding: '9px 18px', borderRadius: 8, background: 'linear-gradient(135deg, #6366f1, #ad5b67)', border: 'none', color: '#fff', fontSize: 13, fontWeight: 600, cursor: 'pointer', fontFamily: 'inherit' },
