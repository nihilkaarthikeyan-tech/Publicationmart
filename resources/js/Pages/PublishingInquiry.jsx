...
export default function PublishingInquiry({ selectedPlan }) {
    ...
    return (
        <>
            ...
            <div className="min-h-screen bg-parchment pt-8 pb-24">
                {/* Hero Header */}
                <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 mb-12">
                    <div className="text-center">
                        <Link
                            href={route('welcome')}
                            className="inline-flex items-center gap-2 text-umber hover:text-ink text-sm font-medium mb-8 transition-colors"
                        >
                            <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15 19l-7-7 7-7" /></svg>
                            Back to Home
                        </Link>
                        <h1 className="text-4xl md:text-5xl font-black text-ink mb-4">
                            Start Your <span className=" text-oxblood">Publishing Journey</span>
                        </h1>
                        <p className="text-lg text-umber max-w-xl mx-auto">
                ...
                {submitted && (
                    <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 mb-8">
                        <div className="bg-emerald-500/10 border border-emerald-500/30 rounded-2xl p-6 text-center">
                            ...
                            <Link
                                href={route('welcome')}
                                className="inline-block mt-4 px-6 py-2.5 bg-paper hover:bg-vellum text-ink font-semibold rounded-xl border border-linen transition-all"
                            >
                                Return to Home
                            </Link>
                        </div>
                ...
                {!submitted && (
                    <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
                        <form onSubmit={handleSubmit} className="bg-paper rounded-3xl border border-linen p-8 md:p-10 space-y-8">
                            ...
                            <div>
                                ...
                                <p className="text-umber text-sm ml-10 mb-6">Tell us about yourself</p>

                                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                                    {/* Name */}
                                    <div>
                                        <label className="block text-sm font-semibold text-ink-soft mb-2">Full Name <span className="text-red-700">*</span></label>
                                        <input
                                            type="text"
                                            value={data.name}
                                    ...
                                    {/* Email */}
                                    <div>
                                        <label className="block text-sm font-semibold text-ink-soft mb-2">Email Address <span className="text-red-700">*</span></label>
                                        <input
                                            type="email"
                                            value={data.email}
                                    ...
                                    <div>
                                        <label className="block text-sm font-semibold text-ink-soft mb-2">Phone Number <span className="text-red-700">*</span></label>
                                        <input
                                            type="tel"
                                            value={data.phone}
                                    ...
                                    {/* WhatsApp */}
                                    <div>
                                        <label className="block text-sm font-semibold text-ink-soft mb-2">WhatsApp Number</label>
                                        <input
                                            type="tel"
                                            value={data.whatsapp}
                            ...
                            {/* Divider */}
                            <div className="h-px bg-paper"></div>
                            ...
                            <div>
                                ...
                                <p className="text-umber text-sm ml-10 mb-6">Tell us about your book</p>

                                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                                    {/* Book Type */}
                                    <div>
                                        <label className="block text-sm font-semibold text-ink-soft mb-2">Book Type <span className="text-red-700">*</span></label>
                                    ...
                                    {/* Book Title */}
                                    <div>
                                        <label className="block text-sm font-semibold text-ink-soft mb-2">Book Title <span className="text-red-700">*</span></label>
                                        <input
                                            type="text"
                            ...
                            <div>
                                ...
                                <p className="text-umber text-sm ml-10 mb-6">Choose the plan that best fits your needs</p>
                                    ...
                                    {plans.map(plan => (
                                        <button
                                            ...
                                            className={`p-4 rounded-xl text-left transition-all border ${data.interested_plan === plan.value
                                                    ...
                                                    : 'bg-paper border-linen hover:border-linen'
                                                }`}
                                        >
                                            <div className="flex items-center justify-between">
                                                <div>
                                                    <p className={`font-bold text-sm ${data.interested_plan === plan.value ? 'text-purple-700' : 'text-ink'}`}>
                                                        {plan.label}
                                                    </p>
                                                    <p className="text-xs text-umber mt-0.5">{plan.subtitle}</p>
                                                </div>
                                                <div className={`w-5 h-5 rounded-full border-2 flex items-center justify-center transition-all ${data.interested_plan === plan.value
                                                    ...
                                                    {data.interested_plan === plan.value && (
                                                        <svg className="w-3 h-3 text-ink" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="3" d="M5 13l4 4L19 7" /></svg>
                                                    )}
                                                </div>
                                            </div>
                                        </button>
                            ...
                            <div className="space-y-6">
                                <label className="flex items-start gap-3 cursor-pointer group">
                                    <input
                                        ...
                                        className="mt-1 w-4 h-4 rounded border-linen bg-paper text-purple-600 focus:ring-purple-500 focus:ring-offset-0 cursor-pointer"
                                    />
                                    <span className="text-sm text-umber group-hover:text-ink-soft transition-colors">
                                        I agree to the{' '}
