            ...
            <div className="min-h-screen bg-[#0f0a1e] flex items-center justify-center p-4">
                <div className="w-full max-w-2xl text-center">
                    ...
                    <h1 className="text-4xl md:text-5xl font-black text-white mb-4">
                        Masterpiece <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 to-cyan-400">Created!</span>
                    </h1>
                    ...
                    <div className="grid md:grid-cols-2 gap-6 mb-12">
                        ...
                        <div className="bg-[#0f1016] border border-indigo-500/30 rounded-3xl p-8 hover:border-indigo-500/60 transition-all group">
                            ...
                            <h3 className="text-xl font-bold text-white mb-2">New Author?</h3>
                            <p className="text-gray-400 text-sm mb-6">Create a free account to save your book and start the publishing process.</p>
                        ...
                        {/* Option 2: Login */}
                        <div className="bg-[#0f1016] border border-white/10 rounded-3xl p-8 hover:border-white/20 transition-all group">
                            ...
                            <h3 className="text-xl font-bold text-white mb-2">Already have an account?</h3>
                            <p className="text-gray-400 text-sm mb-6">Login to add this book to your existing dashboard.</p>

                            <Link
                                href={route('login')}
                                className="block w-full py-3 bg-white/10 hover:bg-white/20 text-white font-bold rounded-xl transition-colors"
                            >
                                Login & Link Book
                            </Link>
                        </div>
                    ...
                    <div className="text-gray-500 text-sm">
                        <p>Your session ID: <span className="font-mono text-gray-400">{token.substring(0, 8)}...</span></p>
