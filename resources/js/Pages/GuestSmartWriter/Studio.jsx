...
export default function GuestStudio({ session, token, existingChapters = [] }) {
    ...
    return (
        <div className="min-h-screen flex flex-col font-sans bg-parchment text-ink selection:bg-indigo-500/30">
            ...
            <div className="fixed top-0 left-0 right-0 z-50 bg-paper/90 backdrop-blur-md border-b border-linen">
                ...
                <div className="h-12 border-t border-linen flex items-center justify-between px-6 bg-paper/80">
                    <h1 className="font-bold text-sm md:text-lg flex items-center gap-2 text-ink pl-20 md:pl-24">
                        <span className="text-xl md:text-2xl">✨</span>
                        <span className="hidden md:inline text-umber text-xs uppercase tracking-wider">Smart Writer</span>
                        <span className="hidden md:inline text-umber mx-2">|</span>
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div className="hidden lg:flex items-center gap-4 mr-2">
                            <div className="flex flex-col items-end">
                                <span className="text-[10px] uppercase font-bold tracking-wider text-umber">Progress</span>
                            ...
                            <div className="w-px h-6 bg-vellum"></div>
                            <div className="flex flex-col items-start">
                                <span className="text-[10px] uppercase font-bold tracking-wider text-umber">Words</span>
            ...
            <main className="pt-32 flex-1 flex overflow-hidden">
                                ...
                                <div className="space-y-5">
                                    ...
                                    <div className="bg-indigo-500/5 rounded-xl border border-indigo-500/20 p-4 mb-4">
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                            <div className="space-y-1.5">
                                                <label className="block text-xs font-semibold text-ink-soft uppercase tracking-wider">Your Name <span className="text-red-700">*</span></label>
                                                <input
                                                    type="text"
                                                    value={initData.full_name || ''}
                                                    onChange={e => setInitData({ ...initData, full_name: e.target.value })}
                                                    className="w-full bg-paper border border-linen rounded-lg px-3 py-2.5 text-sm text-ink focus:outline-none focus:border-indigo-400"
                                                    placeholder="Enter your full name"
                                                />
                                            </div>
                                            <div className="space-y-1.5">
                                                <label className="block text-xs font-semibold text-ink-soft uppercase tracking-wider">Email Address <span className="text-red-700">*</span></label>
                                                <input
                                                    type="email"
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        <div className="space-y-1.5">
                                            ...
                                            <input type="text" value={initData.title} onChange={e => setInitData({ ...initData, title: e.target.value })} className="w-full bg-paper border border-linen rounded-lg px-3 py-2.5 text-sm text-ink focus:outline-none focus:border-indigo-400" placeholder="Enter book title" />
                                        </div>
                                        <div className="space-y-1.5">
                                            <label className="block text-xs font-semibold text-ink-soft uppercase tracking-wider">Author Name</label>
                                            <input type="text" value={initData.author_name} onChange={e => setInitData({ ...initData, author_name: e.target.value })} className="w-full bg-paper border border-linen rounded-lg px-3 py-2.5 text-sm text-ink focus:outline-none focus:border-indigo-400" placeholder="Enter author name" />
                                        </div>
                                    </div>
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        <div className="space-y-1.5">
                                            ...
                                            <select
                                                ...
                                                className="w-full bg-paper border border-linen rounded-lg px-3 py-2.5 text-sm text-ink focus:outline-none focus:border-indigo-400 appearance-none cursor-pointer"
                                            >
                                    ...
                                    <div className="space-y-1.5">
                                        <label className="block text-xs font-semibold text-ink-soft uppercase tracking-wider">Book Concept / Premise <span className="text-cyan-700">*</span></label>
                                        <textarea value={initData.topic} onChange={e => setInitData({ ...initData, topic: e.target.value })} className="w-full bg-paper border border-linen rounded-lg px-3 py-2.5 text-sm text-ink focus:outline-none focus:border-indigo-400 h-20 resize-none" placeholder={initData.genre === 'Fiction' ? "Describe the plot..." : "Describe the topic..."} />
                                    </div>

                                    <div className="bg-paper rounded-xl border border-linen p-4">
                                        <h4 className="text-[10px] font-bold text-ink-soft uppercase tracking-widest mb-4">Structure Settings</h4>
                                        <div className="grid grid-cols-3 gap-4">
                                            ...
                                            {(() => {
                                                ...
                                                return (
                                                    <>
                                                        <div className="space-y-1.5">
                                                            <label className="block text-[10px] font-bold text-umber">Chapters (Max {limits.maxCh})</label>
                                                            <input
                                                                type="number"
                                                                ...
                                                                className="w-full bg-paper border border-linen rounded-lg px-2 py-2 text-ink text-center font-bold"
                                                                min="1"
                                                                max={limits.maxCh}
                                                            />
                                                        </div>
                                                        <div className="space-y-1.5">
                                                            <label className="block text-[10px] font-bold text-umber">Sub-chapters (Max {limits.maxSub})</label>
                                                            <input
                                                                type="number"
                                            ...
                                            <div className="space-y-1.5">
                                                ...
                                                <div className={`w-full border rounded-lg px-2 py-2 text-center text-xs font-bold flex flex-col justify-center ${(() => {
                                                    ...
                                                    const totalSub = (initData.chapter_count || 0) * (initData.sub_chapter_count || 0);
                                                    if (totalSub === 0) return 'bg-paper border-linen text-ink opacity-70';
                                                    ...
                                                    return 'bg-paper border-linen text-emerald-700';
                                                })()
                                                    }`}>
                                                    {(() => {
                                                        const rangeParts = (initData.page_range || '80-100').split('-');
                                        ...
                                        {/* Plan Limits Legend */}
                                        <div className="mt-3 flex items-center gap-2 text-[10px] text-umber bg-paper p-2 rounded-lg border border-linen">
                    ...
                    <div className="w-full max-w-3xl mx-auto py-10 px-4 overflow-y-auto relative">
                        <div className="relative z-10">
                            <div className="text-center mb-6">
                                ...
                                <p className="text-sm text-ink-soft">{chapters.length > 0 ? `${chapters.length} Chapters Generated` : 'Generate your book structure'}</p>
                            </div>
                                ...
                                <div className="bg-paper rounded-2xl border border-linen p-6 md:p-8 shadow-xl text-center">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-2xl mx-auto">
                                        ...
                                        <div onClick={() => generateOutline('ai')} className="group bg-gradient-to-br from-indigo-500/15 to-transparent rounded-xl p-4 border border-indigo-500/30 hover:border-indigo-400/50 transition-all cursor-pointer text-center h-full flex flex-col justify-center">
                                            ...
                                            <h4 className="font-semibold text-ink text-sm mb-1">Smart Writer Mode</h4>
                                            <p className="text-xs text-ink-soft mb-4">Let AI create a structured outline based on your concept.</p>
                                        ...
                                        <div className="group bg-paper rounded-xl p-4 border border-linen hover:border-linen transition-all text-center h-full flex flex-col justify-center relative">
                                            ...
                                            <button
                                                ...
                                                className="w-full py-2 bg-vellum hover:bg-vellum text-ink rounded-lg font-bold text-xs border border-linen mt-auto"
                                            >
                                                Use Manual Outline
                                            </button>
                                        </div>
                                ...
                                <div className="bg-paper rounded-2xl border border-linen p-5 shadow-xl">
                                    <div className="space-y-2 mb-5 max-h-[45vh] overflow-y-auto pr-2">
                                        {chapters.map((chapter, i) => (
                                            <div key={i} className="bg-paper p-3 rounded-lg border border-linen flex items-center gap-3">
                                    ...
                                    <div className="flex justify-between items-center pt-4 border-t border-linen">
                                        <button onClick={() => setStep(1)} className="px-4 py-2 text-sm text-ink-soft hover:text-ink flex items-center gap-2">Back</button>
                ...
                {step === 3 && (
                    <div className="flex w-full h-full">
                        <div className="w-64 bg-paper border-r border-linen overflow-y-auto flex flex-col pt-4">
                            <div className="px-4 mb-4">
                                ...
                                <p className="text-umber text-[10px] mt-1">Select a chapter to generate sub-sections</p>
                            </div>
                            <div className="flex-1">
                                {chapters.map((chapter, i) => (
                                    <div key={i} onClick={() => setActiveChapterId(chapter.id)} className={`p-3 border-b border-linen cursor-pointer hover:bg-paper transition ${activeChapterId === chapter.id ? 'bg-indigo-500/15 border-l-4 border-l-indigo-400' : ''}`}>
                                        <div className="flex justify-between items-start">
                                            <div className="font-medium text-xs text-ink"><span className="text-umber mr-1">{i + 1}.</span>{chapter.title}</div>
                        ...
                        <div className="flex-1 bg-paper p-6 overflow-y-auto relative">
                            {activeChapterId && (
                                <div className="max-w-xl mx-auto relative z-10">
                                    <h2 className="text-lg font-bold mb-1 text-ink">Structure for: <span className="text-indigo-700">{chapters.find(c => c.id === activeChapterId)?.title}</span></h2>
                                    <p className="text-ink-soft text-xs mb-5">Define sub-sections.</p>

                                    {chapters.find(c => c.id === activeChapterId)?.sections?.length > 0 ? (
                                        <div className="space-y-2">
                                            {chapters.find(c => c.id === activeChapterId).sections.map((section, idx) => (
                                                <div key={idx} className="bg-paper p-3 rounded-lg border border-linen flex items-center gap-3">
                                        ...
                                        <div className="bg-paper rounded-xl border border-linen p-8 text-center">
                                            {/* No sections yet icon */}
                                            <div className="w-14 h-14 mx-auto mb-4 bg-paper rounded-xl flex items-center justify-center border border-linen">
                                                <svg className="w-6 h-6 text-umber" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                                                </svg>
                                            </div>
                                            <h4 className="text-ink font-bold text-sm mb-1">No sections yet</h4>
                                            <p className="text-umber text-xs mb-6">Generate sub-headings for this chapter to organize the content.</p>
                ...
                {/* Step 4: Writing */}
                {
                    step === 4 && (
                        <div className="flex w-full h-full">
                            <div className="w-60 bg-paper border-r border-linen flex flex-col pt-4">
                                <div className="px-4 mb-4">
                                ...
                                <div className="flex-1 overflow-y-auto">
                                    {chapters.map(chapter => (
                                        <div key={chapter.id}>
                                            <div className="px-3 py-2 bg-paper text-[10px] font-bold text-ink-soft uppercase tracking-wider sticky top-0 border-b border-linen">{chapter.title}</div>
                                ...
                                {activeSection ? (
                                    <div className="flex-1 flex flex-col h-full">
                                        ...
                                        <div className="flex-1 p-6 overflow-y-auto relative">
                                            <div className="max-w-3xl mx-auto bg-paper min-h-[600px] shadow-xl border border-linen rounded-xl p-8 relative z-10">
                                                {activeSection.image_url && <div className="mb-6 p-2 border border-linen rounded-lg bg-paper text-center"><img src={activeSection.image_url} className="max-w-full h-auto mx-auto rounded-lg shadow-lg" /></div>}
                                                {activeSection.content ? (
                                                    <div
                                                    ...
                                                    <div className="flex flex-col items-center justify-center h-full text-center py-16"><p className="text-ink-soft text-sm font-medium">Click "Write This Section" to generate content.</p></div>
                                                )}
                                            </div>
                                        </div>
                                    </div>
                    ...
                    step === 5 && (
                        <div className="w-full max-w-2xl mx-auto py-10 px-4 relative">
                            <div className="relative z-10 text-center space-y-6">
                                ...
                                {/* Download Section */}
                                <div className="bg-paper rounded-2xl border border-linen p-6 md:p-8 shadow-xl">
                                    <h2 className="text-2xl font-bold text-ink mb-2">Book Compilation Complete!</h2>
                                    <p className="text-sm text-ink-soft mb-6">Your book manuscript is ready.</p>
                                    <div className="space-y-3 max-w-sm mx-auto">
                                        <div className="p-3 bg-paper rounded-xl border border-linen flex items-center justify-between">
                                            <div className="text-left"><div className="font-semibold text-sm text-ink">Microsoft Word (.docx)</div></div>
                                            <a href={route('guest-writer.download-book', { session_token: token, format: 'word' })} className="px-3 py-1.5 bg-vellum hover:bg-vellum border border-linen rounded-lg text-xs font-bold text-ink">Download</a>
                                        </div>
                                        <div className="p-3 bg-paper rounded-xl border border-linen flex items-center justify-between">
                                            <div className="text-left"><div className="font-semibold text-sm text-ink">PDF Document (.pdf)</div></div>
                                            <a href={route('guest-writer.download-book', { session_token: token, format: 'pdf' })} className="px-3 py-1.5 bg-vellum hover:bg-vellum border border-linen rounded-lg text-xs font-bold text-ink">Download</a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="bg-gradient-to-br from-indigo-900/40 to-cyan-900/40 rounded-2xl border border-indigo-500/30 p-6 md:p-8 shadow-xl relative overflow-hidden group">
                                    ...
                                    <div className="relative z-10">
                                        ...
                                        <h3 className="text-xl font-bold text-ink mb-2">Ready to Publish Globally?</h3>
                                        ...
                                        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                                            <Link href={route('login')} className="w-full sm:w-auto px-6 py-2.5 bg-paper hover:bg-paper border border-linen text-ink font-bold text-sm rounded-lg transition-all">
                                                Login to Account
                                            </Link>
                    ...
                    <div className="fixed inset-0 bg-vellum/70 backdrop-blur-sm flex items-center justify-center z-[100] p-4">
                        <div className="bg-paper rounded-2xl border border-linen w-full max-w-md overflow-hidden shadow-2xl">
                            ...
                            <div className="p-4 space-y-4">
                                <p className="text-sm text-ink-soft">Generate for: <span className="text-ink font-semibold">{activeSection?.title}</span></p>
                                <div className="grid grid-cols-2 gap-3">
                                    <button onClick={() => setImagePromptMode('auto')} className={`p-4 rounded-xl border text-center transition-all ${imagePromptMode === 'auto' ? 'border-indigo-500 bg-indigo-500/20 text-white' : 'border-linen bg-paper text-ink-soft'}`}>
                                        <span className="block text-sm font-bold">Auto (AI)</span>
                                    </button>
                                    <button onClick={() => setImagePromptMode('custom')} className={`p-4 rounded-xl border text-center transition-all ${imagePromptMode === 'custom' ? 'border-cyan-500 bg-cyan-500/20 text-white' : 'border-linen bg-paper text-ink-soft'}`}>
                                        <span className="block text-sm font-bold">Custom</span>
                                    </button>
                                </div>
                                {imagePromptMode === 'custom' && (
                                    <textarea value={customImagePrompt} onChange={e => setCustomImagePrompt(e.target.value)} placeholder="Describe the image..." className="w-full bg-paper border border-linen rounded-lg px-3 py-2 text-ink text-sm h-24 resize-none" />
                                )}
                            </div>
                            <div className="p-4 border-t border-linen flex gap-3">
                                <button onClick={() => setShowImagePromptModal(false)} className="flex-1 py-2.5 bg-paper text-ink-soft font-semibold rounded-lg text-sm border border-linen">Cancel</button>
