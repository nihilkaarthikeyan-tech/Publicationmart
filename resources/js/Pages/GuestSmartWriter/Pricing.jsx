            ...
            <div className="min-h-screen bg-[#f0ece3] text-[#17150f] font-sans selection:bg-indigo-500 selection:text-[#17150f] overflow-x-hidden">
                ...
                <section className="relative pt-24 pb-12 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
                    ...
                    <div className={`text-center mb-12 transition-all duration-1000 transform ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        {/* Badge */}
                        <div className="inline-flex items-center gap-3 px-5 py-2 mb-8 rounded-full bg-[#faf8f3] border border-[#d8d1c1] text-sm font-medium text-[#4b443a]">
                            <span className="text-[10px] font-black uppercase tracking-widest text-[#635c4e] border-r border-[#d8d1c1] pr-3">IN INDIA'S FIRST</span>
                        ...
                        <h1 className="text-5xl md:text-7xl font-black mb-4 tracking-tight leading-tight">
                            <span className="text-[#17150f]">Turn Ideas into Books</span>
                            <br />
                    ...
                    <div className={`grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto transition-all duration-1000 delay-200 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        {/* PRO CARD */}
                        <div className="relative bg-white/[0.04] border border-[#d8d1c1] rounded-3xl p-8 hover:border-[#7c7364] hover:bg-white/[0.06] transition-all duration-300 group">
                            ...
                            <button
                                onClick={scrollToPro}
                                className="w-full py-3.5 border border-[#d8d1c1] text-[#17150f] font-bold rounded-xl hover:bg-[#e7e1d4] transition-all text-sm tracking-wider uppercase"
                            >
                                View Pro Plans →
                            </button>
                        </div>
                        ...
                        <div className="relative bg-[#faf8f3] border border-gray-700/40 rounded-3xl p-8 opacity-60 group overflow-hidden">
                            {/* Premium badge */}
                            <div className="absolute top-5 right-5">
                                <span className="bg-[#4b443a] text-[#faf8f3] text-[10px] font-black px-3 py-1.5 rounded-full uppercase tracking-widest shadow-lg">
                                    COMING SOON
                                </span>
                            </div>
                            <div className="absolute top-0 right-0 w-48 h-48 bg-gray-600/10 rounded-full blur-[60px] pointer-events-none" />

                            <h3 className="text-2xl font-bold text-[#635c4e] mb-1">Premium</h3>
                            <p className="text-[#635c4e] text-sm mb-6">Complete suite for professional authors</p>
                            <ul className="space-y-4 mb-8">
                            ...
                            <button
                                disabled
                                className="w-full py-3.5 bg-gray-100 border border-gray-700/40 text-[#635c4e] font-bold rounded-xl cursor-not-allowed text-sm tracking-wider uppercase"
                            >
                                Coming Soon
                            </button>
                        </div>
                ...
                <section className="relative pb-24 px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto">
                    ...
                    <div className="space-y-16 md:space-y-24">
                        <StepCard number="1" title="Instant First Draft" subtitle="Within 120 Seconds" icon="⚡" side="right" delay={100} gradient="from-indigo-500 to-purple-600" glowColor="indigo">
                            <p className="text-[#635c4e] mb-4">Simply enter your book idea, topic, or prompt — and the system generates:</p>
                        ...
                        <StepCard number="2" title="Outline Review & Approval" subtitle="You Remain Fully in Control" icon="🛡️" side="left" delay={200} gradient="from-purple-500 to-pink-600" glowColor="purple">
                            <p className="text-[#635c4e] mb-4">Before the manuscript is developed, you can:</p>
                            <ul className="space-y-2">
                        ...
                        <StepCard number="3" title="Automatic Full Draft" subtitle="Ready for Review & Refinement" icon="🚀" side="right" delay={300} gradient="from-pink-500 to-rose-600" glowColor="rose">
                            <p className="text-[#635c4e] mb-4">Once approved, the system generates the complete manuscript. It expands chapters, maintains consistency, and ensures smooth flow.</p>
                            <p className="text-[#635c4e] text-sm mt-4 italic border-l-2 border-pink-500/30 pl-3">Within minutes, you receive a complete first draft ready for your review.</p>
                        </StepCard>
                    </div>
                </section>
                    ...
                    <div className="max-w-7xl mx-auto">
                        <div className="grid lg:grid-cols-2 gap-16 items-center">
                            ...
                            <div className="relative group">
                                ...
                                <div className="relative bg-[#faf8f3] border border-orange-500/30 rounded-3xl p-8 md:p-10">
                                    ...
                                    <div className="bg-orange-500/10 rounded-xl p-4 border border-orange-500/20">
                                        <p className="text-xs text-orange-800 italic">"Publishing a book is a serious commitment. While AI accelerates writing, quality, credibility, and integrity depend on thoughtful human oversight."</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                {/* ═══ PRO PRICING GRID ═══ */}
                <div ref={proGridRef} className="pt-24 pb-16 relative z-10 border-t border-[#d8d1c1] bg-[#faf8f3]">
                    <div className="max-w-7xl mx-auto px-6">
                        <div className="text-center mb-16">
                            <span className="inline-block px-4 py-1.5 rounded-full bg-indigo-500/10 border border-indigo-500/20 text-indigo-700 text-xs font-bold uppercase tracking-widest mb-4">Pro Plans</span>
                            <h2 className="text-4xl font-black text-[#17150f] mb-4">Select Your Pro Plan</h2>
                            <p className="text-[#635c4e] text-lg">Choose a plan based on your desired book length.</p>
                        </div>
                        ...
                        <div className="text-center mt-10">
                            <button onClick={scrollToPremium} className="text-sm text-[#635c4e] hover:text-cyan-700 transition-colors underline underline-offset-4">
                ...
                <div ref={premiumGridRef} className="pt-16 pb-32 relative z-10 bg-[#faf8f3]">
                    <div className="max-w-7xl mx-auto px-6">
                        {/* Premium Coming Soon Message */}
                        <div className="flex items-center justify-center mb-16">
                            <div className="text-center">
                                <span className="inline-block px-4 py-1.5 rounded-full bg-gray-100 border border-gray-700/40 text-[#635c4e] text-xs font-bold uppercase tracking-widest mb-4">Premium Plans</span>
                                <h2 className="text-4xl font-black text-[#635c4e] mb-2">Premium Plans Coming Soon</h2>
                                <p className="text-[#635c4e]">We're preparing an enhanced experience. Stay tuned for premium features!</p>
                            </div>
                        </div>
                    </div>
                </div>
...
function TierFeature({ icon, title, desc, color = 'indigo' }) {
    let checkColor = 'text-indigo-700';
    let titleColor = 'text-[#17150f]';
    let descColor = 'text-[#635c4e]';

    if (color === 'cyan') {
        checkColor = 'text-cyan-700';
    } else if (color === 'gray') {
        checkColor = 'text-[#635c4e]';
        titleColor = 'text-[#635c4e]';
        descColor = 'text-[#635c4e]';
    }
...
function PricingCard({ plan, tier, accentClass }) {
    ...
    const btnClass = plan.popular
        ...
        : (isPremium
            ? 'bg-cyan-500/10 hover:bg-cyan-500/20 text-cyan-700 border border-cyan-500/30 hover:border-cyan-400/50'
            : 'bg-white/5 hover:bg-white/10 text-white border border-white/10 hover:border-indigo-500/30 hover:text-indigo-700');
    ...
    return (
        <div className={`relative flex flex-col group ${plan.popular ? 'lg:-translate-y-4' : ''}`}>
            ...
            <div className={`relative flex flex-col h-full bg-[#faf8f3] rounded-[20px] border ${borderColor} overflow-hidden transition-all duration-300 group-hover:border-${accentClass}-500/30 group-hover:transform group-hover:-translate-y-1 group-hover:shadow-2xl`}>
                <div className="p-8 pb-32 flex-1">
                    <h3 className="text-xl font-black text-[#17150f] mb-4 uppercase tracking-wider">{plan.name}</h3>
                    <div className="flex items-baseline gap-2 mb-2">
                        <span className="text-4xl font-black text-[#17150f]">₹{plan.price.toLocaleString('en-IN')}</span>
                        <span className="text-sm text-[#635c4e] line-through">₹{plan.originalPrice.toLocaleString('en-IN')}</span>
                    </div>
                    <div className="mb-8 p-3 bg-[#faf8f3] rounded-xl border border-[#d8d1c1]">
                        <span className={`text-[#6e2530] text-sm font-bold flex items-center gap-2`}>
                    ...
                    <ul className="space-y-4">
                        {plan.features.map((feature, idx) => (
                            <li key={idx} className="flex items-start gap-3">
                                ...
                                <span className="text-sm text-[#635c4e] font-medium group-hover:text-[#4b443a] transition-colors">{feature}</span>
                            </li>
                        ))}
                    </ul>
                </div>
...
function StepCard({ number, title, subtitle, icon, side, delay, gradient, glowColor, children }) {
    ...
    return (
        <div ref={domRef} className={`flex flex-col md:flex-row items-start md:items-center relative group ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'} transition-all duration-1000 ease-out`} style={{ transitionDelay: `${delay}ms` }}>
            <div className={`absolute left-6 md:left-1/2 w-12 h-12 rounded-full bg-gradient-to-br ${gradient} flex items-center justify-center text-[#17150f] font-black text-lg shadow-lg z-10 transform md:-translate-x-1/2 border-4 border-[#17150f] ring-2 ring-[#d8d1c1]`}>{number}</div>
            ...
            <div className={`w-full md:w-[46%] pl-24 md:pl-0 ${!isRight ? 'md:mr-auto md:pr-14' : 'md:ml-auto md:pl-14'}`}>
                <div className={`bg-white/[0.03] backdrop-blur-sm border border-white/[0.08] p-8 rounded-2xl hover:bg-white/[0.06] hover:border-[#d8d1c1] transition-all duration-500 relative overflow-hidden ${glowColors[glowColor] || ''}`}>
                    ...
                    <div className={`flex items-start gap-3 mb-2 ${!isRight ? 'md:flex-row-reverse md:text-right' : ''}`}>
                        ...
                        <div className="flex-1">
                            <h3 className="text-xl font-bold text-[#17150f] mb-1">{title}</h3>
                            <p className="text-[#635c4e] text-sm font-mono">{subtitle}</p>
                        </div>
                    </div>
...
function FeatureRow({ icon, title, desc }) {
    return (
        <div className="flex gap-5 p-4 rounded-2xl hover:bg-[#faf8f3] transition-colors duration-300 border border-transparent hover:border-[#d8d1c1]">
            <div className="w-12 h-12 rounded-xl bg-[#e7e1d4] flex items-center justify-center shrink-0 text-xl backdrop-blur-sm">{icon}</div>
            <div>
                <h4 className="font-bold text-[#17150f] text-lg">{title}</h4>
                <p className="text-sm text-[#635c4e] mt-1">{desc}</p>
            </div>
        </div>
    );
}
