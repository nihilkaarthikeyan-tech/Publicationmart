            ...
            <div className="min-h-screen bg-parchment text-ink font-sans selection:bg-purple-500 selection:text-paper pb-20 pt-24">
                ...
                <div className="px-6 text-center max-w-5xl mx-auto relative">
                    ...
                    <div className="absolute top-0 right-0 hidden md:block">
                        <Link href={route('blogs.create')} className="bg-paper border border-linen hover:border-taupe text-umber hover:text-ink px-4 py-2 rounded-full text-xs font-bold transition-all flex items-center gap-2">
                    ...
                    <h1 className="text-5xl md:text-7xl font-bold mb-6 tracking-tight">
                        Insights for <span className=" text-oxblood">Authors</span>
                    </h1>
                    <p className="text-xl text-umber mb-12 max-w-2xl mx-auto">
                        Expert advice on writing, publishing, and book marketing.
                    </p>

                    {/* Redesigned Search & Filter Bar */}
                    <div className="bg-paper/80 backdrop-blur-md border border-linen rounded-2xl p-2 max-w-4xl mx-auto shadow-2xl shadow-purple-900/10 flex flex-col md:flex-row gap-2">

                        {/* Search Input */}
                        <div className="relative flex-grow group">
                            <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-umber group-focus-within:text-purple-500 transition-colors">
                        ...
                        {/* Divider */}
                        <div className="hidden md:block w-px bg-paper my-2"></div>
                        ...
                        <div className="flex gap-1 overflow-x-auto md:max-w-md items-center px-2 scrollbar-hide py-2 md:py-0" style={{ scrollbarWidth: 'none', msOverflowStyle: 'none' }}>
                            ...
                            {categories.map(cat => (
                                <button
                                    ...
                                    className={`px-4 py-2 rounded-xl text-xs font-bold whitespace-nowrap transition-all ${selectedCategory === cat ? 'bg-oxblood text-paper shadow-md' : 'text-ink/80 hover:text-ink hover:bg-paper'}`}
                                >
                                    {cat}
                                </button>
                            ))}
                ...
                <div className="max-w-6xl mx-auto px-6 mt-16 mb-8">
                    ...
                    >
                        <div className="bg-gradient-to-r from-purple-900/40 via-paper to-purple-900/40 border border-violet-700/50 rounded-2xl p-6 flex items-center justify-between hover:border-purple-500/60 transition-all duration-300">
                            <div className="flex items-center gap-4">
                                <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-purple-600 to-pink-600 flex items-center justify-center shadow-lg shadow-purple-900/40 shrink-0">
                                    <svg className="w-6 h-6 text-ink" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
                                </div>
                                <div className="text-left">
                                    <h2 className="text-lg md:text-xl font-bold text-ink group-hover:text-purple-700 transition-colors">
                                        Book Studio — Community Publishing Model
                                    </h2>
                                    <p className="text-sm text-umber mt-0.5">Learn how our community-driven publishing platform works</p>
                                </div>
                            </div>
                            <div className={`w-8 h-8 rounded-full bg-paper border border-linen flex items-center justify-center transition-transform duration-300 ${showInfo ? 'rotate-180' : ''}`}>
                                <svg className="w-4 h-4 text-umber" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M19 9l-7 7-7-7" /></svg>
                            </div>
                        </div>
                    </button>
                    ...
                    {showInfo && (
                        <div className="mt-4 space-y-6 animate-fadeIn">
                            ...
                            {/* Mission Statement */}
                            <div className="bg-paper/60 border border-linen rounded-2xl p-6 md:p-8">
                            ...
                            <div className="bg-paper/60 border border-linen rounded-2xl p-6 md:p-8">
                                <div className="flex items-center gap-3 mb-4">
                                    ...
                                    <h3 className="text-lg font-bold text-ink">Community Launch Mode</h3>
                                </div>
                                <p className="text-umber text-sm mb-6">
                                ...
                                <div className="space-y-3">
                                    {[
                                        ...
                                        <div key={item.step} className="flex items-start gap-3 bg-white/[0.03] rounded-xl p-3 border border-linen">
                            ...
                            <div className="grid md:grid-cols-2 gap-4">
                                ...
                                <div className="bg-gradient-to-br from-paper to-parchment border border-linen rounded-2xl p-6 md:p-8 relative overflow-hidden group hover:border-taupe transition-all">
                                    ...
                                    <div className="relative z-10">
                                        <div className="flex items-center gap-3 mb-3">
                                            ...
                                            <div>
                                                ...
                                                <h4 className="text-ink font-bold">100 Verified Reservations</h4>
                                            </div>
                                        </div>
                                        <p className="text-umber text-sm mb-4">When a book reaches 100 verified support reservations:</p>
                                        <div className="space-y-2.5">
                                            <div className="flex items-center gap-2.5">
                                                ...
                                                <span className="text-ink-soft text-sm font-medium">The book advances to the publication stage</span>
                                            </div>
                                            <div className="flex items-center gap-2.5">
                                                <svg className="w-5 h-5 text-emerald-700 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.5" d="M5 13l4 4L19 7" /></svg>
                                                <span className="text-ink-soft text-sm font-medium">Publication costs will be covered by the publisher</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div className="relative z-10">
                                        <div className="flex items-center gap-3 mb-3">
                                            <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-pink-500 to-purple-600 flex items-center justify-center shadow-lg">
                                                <svg className="w-5 h-5 text-ink" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l2.286 6.857L21 12l-5.714 2.143L13 21l-2.286-6.857L5 12l5.714-2.143L13 3z" /></svg>
                                            </div>
                                            <div>
                                                <span className="text-xs font-bold text-pink-700 uppercase tracking-widest">Milestone 2</span>
                                                <h4 className="text-ink font-bold">250 Sales Within 90 Days</h4>
                                            </div>
                                        </div>
                                        <p className="text-umber text-sm mb-4">When a book reaches 250 verified sales within 90 days of its official launch:</p>
                                        <div className="space-y-2.5">
                                            <div className="flex items-center gap-2.5">
                                                <svg className="w-5 h-5 text-emerald-700 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.5" d="M5 13l4 4L19 7" /></svg>
                                                <span className="text-ink-soft text-sm font-medium">Author receives a professionally developed website in their name</span>
                                            </div>
                                            <div className="flex items-center gap-2.5">
                                                <svg className="w-5 h-5 text-emerald-700 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.5" d="M5 13l4 4L19 7" /></svg>
                                                <span className="text-ink-soft text-sm font-medium">Domain registration, hosting, and maintenance costs for the first year fully covered</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                {filteredBlogs.length > 0 && (
                    <div className="max-w-7xl mx-auto px-6 mb-16 mt-16">
                        <Link href={route('blogs.show', filteredBlogs[0].slug)} className="group block relative rounded-3xl overflow-hidden aspect-[21/9] border border-linen">
                            ...
                            <div className="absolute bottom-0 left-0 p-8 md:p-12 z-20 max-w-3xl">
                                <span className="inline-block px-3 py-1 bg-oxblood text-white text-xs font-bold rounded-full mb-4 uppercase tracking-wider">
                                    {filteredBlogs[0].category}
                                </span>
                                <h2 className="text-3xl md:text-5xl font-bold mb-4 group-hover:text-purple-700 transition-colors">
                                    {filteredBlogs[0].title}
                                </h2>
                                <p className="text-ink-soft text-lg line-clamp-2 mb-6">
                                ...
                                <div className="flex items-center gap-3 text-sm font-bold text-ink">
                                    ...
                                    <span className="text-umber">{new Date(filteredBlogs[0].published_at).toLocaleDateString()}</span>
                                </div>
                            </div>
                        </Link>
                    </div>
                ...
                <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {filteredBlogs.slice(1).map(blog => (
                        <Link key={blog.id} href={route('blogs.show', blog.slug)} className="group bg-paper border border-linen rounded-2xl overflow-hidden hover:border-taupe transition-colors flex flex-col h-full">
                            <div className="aspect-video relative overflow-hidden">
                                ...
                                <div className="absolute top-4 left-4">
                                    <span className="px-3 py-1 bg-paper backdrop-blur-md text-ink text-xs font-bold rounded-full border border-linen">
                                        {blog.category}
                                    </span>
                                </div>
                            </div>
                            <div className="p-6 flex flex-col flex-grow">
                                ...
                                <p className="text-umber text-sm mb-6 line-clamp-3 flex-grow">
                                    {blog.excerpt}
                                </p>
                                <div className="flex items-center justify-between text-xs text-umber font-bold pt-4 border-t border-linen">
                                    <span className="text-ink">{blog.author_name}</span>
                ...
                {filteredBlogs.length === 0 && (
                    <div className="text-center py-20">
                        <p className="text-umber text-lg">No articles found matching your search.</p>
                    </div>
                )}
