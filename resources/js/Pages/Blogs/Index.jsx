...
export default function Index({ blogs }) {
    ...
    return (
        <>
            ...
            <div className="min-h-screen bg-[#1e1535] text-white font-sans selection:bg-purple-500 selection:text-white pb-20 pt-24">
                ...
                <div className="px-6 text-center max-w-5xl mx-auto relative">
                    ...
                    <div className="absolute top-0 right-0 hidden md:block">
                        <Link href={route('blogs.create')} className="bg-[#2d2347] border border-violet-800/50 hover:border-purple-500 text-gray-400 hover:text-white px-4 py-2 rounded-full text-xs font-bold transition-all flex items-center gap-2">
                    ...
                    <div className="bg-[#2d2347]/80 backdrop-blur-md border border-violet-800/50 rounded-2xl p-2 max-w-4xl mx-auto shadow-2xl shadow-purple-900/10 flex flex-col md:flex-row gap-2">
                ...
                <div className="max-w-6xl mx-auto px-6 mt-16 mb-8">
                    ...
                    >
                        <div className="bg-gradient-to-r from-purple-900/40 via-[#2d2347] to-purple-900/40 border border-violet-700/50 rounded-2xl p-6 flex items-center justify-between hover:border-purple-500/60 transition-all duration-300">
                    ...
                    {showInfo && (
                        <div className="mt-4 space-y-6 animate-fadeIn">
                            ...
                            {/* Mission Statement */}
                            <div className="bg-[#2d2347]/60 border border-violet-800/40 rounded-2xl p-6 md:p-8">
                            ...
                            <div className="grid md:grid-cols-2 gap-4">
                                ...
                                <div className="bg-gradient-to-br from-[#2d2347] to-[#1e1535] border border-violet-700/50 rounded-2xl p-6 md:p-8 relative overflow-hidden group hover:border-purple-500/60 transition-all">
                ...
                <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {filteredBlogs.slice(1).map(blog => (
                        <Link key={blog.id} href={route('blogs.show', blog.slug)} className="group bg-[#2d2347] border border-violet-800/50 rounded-2xl overflow-hidden hover:border-violet-600/60 transition-colors flex flex-col h-full">
