        ...
        <>
            ...
            <div className={`min-h-screen bg-[#17150f] text-white font-sans selection:bg-purple-500 selection:text-white pb-20 pt-32 ${isBookingOpen ? 'overflow-hidden blur-sm' : ''}`}>
                ...
                <div className="pb-10 px-6 max-w-4xl mx-auto text-center relative z-10">
                    ...
                    <div className="absolute top-0 right-0 hidden md:block">
                        <button
                            ...
                            className="flex items-center gap-2 px-4 py-2 bg-gray-900/50 backdrop-blur-md border border-gray-700/50 hover:border-purple-500/50 rounded-full text-gray-300 hover:text-white transition-all group"
                        >
                    ...
                    <div className="flex justify-center gap-2 mb-6">
                        <span className="px-3 py-1 bg-purple-900/30 text-purple-400 border border-purple-500/20 text-xs font-bold rounded-full uppercase tracking-wider">
                            {blog.category}
                        </span>
                        {blog.is_presale && (
                            <span className="px-3 py-1 bg-yellow-900/30 text-yellow-400 border border-yellow-500/20 text-xs font-bold rounded-full uppercase tracking-wider animate-pulse">
                                Presale Open
                            </span>
                        )}
                    ...
                    {blog.is_presale && (
                        <div className="mb-8">
                            <div className="flex flex-wrap justify-center gap-4 mb-8">
                                <div className="flex items-center gap-2 px-4 py-2 bg-blue-500/10 border border-blue-500/20 rounded-full text-blue-400 text-sm font-bold shadow-lg shadow-blue-900/20 backdrop-blur-sm">
                                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" /><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" /></svg>
                                    {blog.access_attempts} Views
                                </div>
                                <div className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-orange-500/10 to-red-500/10 border border-orange-500/20 rounded-full text-orange-400 text-sm font-bold shadow-lg shadow-orange-900/20 backdrop-blur-sm">
                            ...
                            <button
                                ...
                                className="px-8 py-4 bg-gradient-to-r from-yellow-600 to-orange-600 hover:from-yellow-500 hover:to-orange-500 text-white font-bold rounded-xl shadow-lg shadow-orange-900/20 transform hover:scale-105 transition-all duration-200"
                            >
                                Book Presale Copies
                            </button>
                        </div>
                    ...
                    <div className="flex items-center justify-center gap-4">
                        ...
                        <div className="text-left">
                            <div className="text-white font-bold">{blog.author_name}</div>
                ...
                <div className="max-w-3xl mx-auto px-6 mt-20 pt-10 border-t border-gray-800 flex justify-between items-center">
                    <Link href={route('blogs.index')} className="text-gray-400 hover:text-white font-bold flex items-center gap-2 transition-colors">
                        ← Back to Book Studio
                    </Link>
                </div>
            </div >
            ...
            {/* Share Modal */}
            {
                isShareOpen && (
                    <div className="fixed inset-0 z-[60] flex items-center justify-center px-4">
                        <div className="absolute inset-0 bg-black/80 backdrop-blur-sm" onClick={() => setIsShareOpen(false)}></div>
                        <div className="relative bg-[#1a1a1e] border border-gray-700 p-8 rounded-2xl shadow-2xl w-full max-w-sm animate-in fade-in zoom-in duration-200">
                            <button onClick={() => setIsShareOpen(false)} className="absolute top-4 right-4 text-gray-400 hover:text-white">
                                <X className="w-5 h-5" />
                            </button>

                            <h3 className="text-xl font-bold text-white mb-6 text-center">Share this Article</h3>
                            ...
                            <div className="grid grid-cols-4 gap-4 mb-6">
                                ...
                                <a
                                    ...
                                    className="flex flex-col items-center gap-2 group"
                                >
                                    <div className="w-12 h-12 rounded-full bg-blue-400/10 border border-blue-400/20 flex items-center justify-center group-hover:bg-blue-400 group-hover:text-black transition-all text-blue-400">
                                ...
                                <a
                                    ...
                                    className="flex flex-col items-center gap-2 group"
                                >
                                    <div className="w-12 h-12 rounded-full bg-gray-500/10 border border-gray-500/20 flex items-center justify-center group-hover:bg-gray-500 group-hover:text-black transition-all text-gray-400">
                            ...
                            {/* Copy Link */}
                            <div className="flex items-center gap-2 bg-[#0a0a0c] border border-gray-700 rounded-lg p-2 pl-3">
                                <input
                                    type="text"
                                    readOnly
                                    value={shareUrl}
                                    className="bg-transparent border-none text-gray-400 text-sm flex-1 focus:ring-0 truncate"
                                />
                                <button
                                    onClick={handleCopy}
                ...
                isBookingOpen && (
                    <div className="fixed inset-0 z-50 flex items-center justify-center px-4">
                        ...
                        <div className="relative bg-[#1a1a1e] border border-gray-700 p-8 rounded-2xl shadow-2xl w-full max-w-md animate-in fade-in zoom-in duration-200">
                            <button onClick={() => setIsBookingOpen(false)} className="absolute top-4 right-4 text-gray-400 hover:text-white">
                                <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M6 18L18 6M6 6l12 12" /></svg>
                            </button>

                            <h2 className="text-2xl font-bold text-white mb-2">Book Presale Copies</h2>
                            <p className="text-gray-400 text-sm mb-6">Reserve your copies of "{blog.title}" before the official launch.</p>

                            <form onSubmit={handleBooking} className="space-y-4">
                                <div>
                                    <label className="block text-xs font-bold text-gray-400 uppercase tracking-widest mb-1">Number of Copies</label>
                                    <input
                                        type="number"
                                        min="1"
                                        value={data.copies_count}
                                        onChange={e => setData('copies_count', e.target.value)}
                                        className="w-full bg-[#0a0a0c] border border-gray-600 rounded-lg px-4 py-3 text-white focus:border-yellow-500 focus:ring-1 focus:ring-yellow-500 outline-none"
                                    />
                                    {errors.copies_count && <div className="text-red-500 text-xs mt-1">{errors.copies_count}</div>}
                                </div>

                                <div>
                                    <label className="block text-xs font-bold text-gray-400 uppercase tracking-widest mb-1">Email Details</label>
                                    <input
                                        type="email"
                                        value={data.email}
                                ...
                                {!otpSent && (
                                    <div className="bg-gray-800/50 p-4 rounded-xl border border-gray-700/50">
                                        <label className="block text-xs font-bold text-gray-400 uppercase tracking-widest mb-2">
                                            Prove you are human: <span className="text-white text-lg ml-2">{captchaQuestion}</span>
                                        </label>
                                        <div className="flex gap-2">
                                            <input
                                                ...
                                                className="w-full bg-[#0a0a0c] border border-gray-600 rounded-lg px-4 py-2 text-white focus:border-yellow-500 focus:ring-1 focus:ring-yellow-500 outline-none"
                                                placeholder="Answer"
                                            />
                                            <button
                                                type="button"
                                ...
                                {otpSent && (
                                    <div className="animate-in fade-in slide-in-from-top-2 duration-300">
                                        <label className="block text-xs font-bold text-green-400 uppercase tracking-widest mb-1">
                                        ...
                                        <input
                                            ...
                                            className="w-full bg-[#0a0a0c] border border-green-500/50 rounded-lg px-4 py-3 text-white focus:border-green-500 focus:ring-1 focus:ring-green-500 outline-none"
                                            placeholder="6-digit OTP"
                                        />
                                        <div className="text-green-500 text-xs mt-1 flex justify-between">
                                            <span>OTP sent to {data.email}</span>
                                            <button type="button" onClick={() => { setOtpSent(false); fetchCaptcha(); }} className="text-gray-400 hover:text-white underline">Resend?</button>
                                        </div>
                                ...
                                <div>
                                    <label className="block text-xs font-bold text-gray-400 uppercase tracking-widest mb-1">Mobile Number</label>
                                    <input
                                        type="tel"
                                ...
                                <button
                                    ...
                                    className="w-full py-3.5 bg-yellow-600 hover:bg-yellow-500 text-white font-bold rounded-xl transition-colors disabled:opacity-50 disabled:cursor-not-allowed mt-2"
                                >
