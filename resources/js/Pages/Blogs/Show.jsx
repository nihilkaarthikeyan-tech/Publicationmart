...
export default function Show({ blog }) {
    ...
    return (
        <>
            ...
            <div className={`min-h-screen bg-[#f0ece3] text-[#17150f] font-sans selection:bg-purple-500 selection:text-[#17150f] pb-20 pt-32 ${isBookingOpen ? 'overflow-hidden blur-sm' : ''}`}>
                ...
                <div className="pb-10 px-6 max-w-4xl mx-auto text-center relative z-10">
                    ...
                    <div className="absolute top-0 right-0 hidden md:block">
                        <button
                            ...
                            className="flex items-center gap-2 px-4 py-2 bg-gray-50 backdrop-blur-md border border-gray-700/50 hover:border-[#7c7364] rounded-full text-[#4b443a] hover:text-[#17150f] transition-all group"
                        >
                    ...
                    {blog.is_presale && (
                        <div className="mb-8">
                            ...
                            <button
                                ...
                                className="px-8 py-4 bg-gradient-to-r from-yellow-600 to-orange-600 hover:from-yellow-500 hover:to-orange-500 text-[#17150f] font-bold rounded-xl shadow-lg shadow-orange-900/20 transform hover:scale-105 transition-all duration-200"
                            >
                                Book Presale Copies
                            </button>
                        </div>
                    ...
                    <div className="flex items-center justify-center gap-4">
                        ...
                        <div className="text-left">
                            <div className="text-[#17150f] font-bold">{blog.author_name}</div>
                ...
                <div className="max-w-3xl mx-auto px-6 mt-20 pt-10 border-t border-gray-800 flex justify-between items-center">
                    <Link href={route('blogs.index')} className="text-[#635c4e] hover:text-[#17150f] font-bold flex items-center gap-2 transition-colors">
                        ← Back to Book Studio
                    </Link>
                </div>
            </div >
                ...
                isShareOpen && (
                    <div className="fixed inset-0 z-[60] flex items-center justify-center px-4">
                        ...
                        <div className="relative bg-[#1a1a1e] border border-gray-700 p-8 rounded-2xl shadow-2xl w-full max-w-sm animate-in fade-in zoom-in duration-200">
                            ...
                            <h3 className="text-xl font-bold text-[#17150f] mb-6 text-center">Share this Article</h3>
                            ...
                            <div className="grid grid-cols-4 gap-4 mb-6">
                                ...
                                >
                                    ...
                                    <span className="text-xs text-[#635c4e] group-hover:text-[#17150f]">WhatsApp</span>
                                </a>
                                ...
                                >
                                    ...
                                    <span className="text-xs text-[#635c4e] group-hover:text-[#17150f]">Twitter</span>
                                </a>
                                ...
                                >
                                    ...
                                    <span className="text-xs text-[#635c4e] group-hover:text-[#17150f]">LinkedIn</span>
                                </a>
                                ...
                                <a
                                    ...
                                    className="flex flex-col items-center gap-2 group"
                                >
                                    <div className="w-12 h-12 rounded-full bg-gray-500/10 border border-gray-500/20 flex items-center justify-center group-hover:bg-gray-500 group-hover:text-black transition-all text-[#635c4e]">
                                        <Mail className="w-5 h-5" />
                                    </div>
                                    <span className="text-xs text-[#635c4e] group-hover:text-[#17150f]">Email</span>
                                </a>
                            </div>

                            {/* Copy Link */}
                            <div className="flex items-center gap-2 bg-[#f0ece3] border border-gray-700 rounded-lg p-2 pl-3">
                                <input
                                    type="text"
                                    readOnly
                                    value={shareUrl}
                                    className="bg-transparent border-none text-[#635c4e] text-sm flex-1 focus:ring-0 truncate"
                                />
                                <button
                                    onClick={handleCopy}
                                    className="p-2 bg-[#faf8f3] hover:bg-gray-700 rounded-md text-[#4b443a] transition-colors"
                ...
                isBookingOpen && (
                    <div className="fixed inset-0 z-50 flex items-center justify-center px-4">
                        ...
                        <div className="relative bg-[#1a1a1e] border border-gray-700 p-8 rounded-2xl shadow-2xl w-full max-w-md animate-in fade-in zoom-in duration-200">
                            ...
                            <h2 className="text-2xl font-bold text-[#17150f] mb-2">Book Presale Copies</h2>
                            <p className="text-[#635c4e] text-sm mb-6">Reserve your copies of "{blog.title}" before the official launch.</p>

                            <form onSubmit={handleBooking} className="space-y-4">
                                <div>
                                    <label className="block text-xs font-bold text-[#635c4e] uppercase tracking-widest mb-1">Number of Copies</label>
                                    <input
                                        type="number"
                                        min="1"
                                        value={data.copies_count}
                                        onChange={e => setData('copies_count', e.target.value)}
                                        className="w-full bg-[#f0ece3] border border-gray-600 rounded-lg px-4 py-3 text-[#17150f] focus:border-yellow-500 focus:ring-1 focus:ring-yellow-500 outline-none"
                                    />
                                    {errors.copies_count && <div className="text-red-500 text-xs mt-1">{errors.copies_count}</div>}
                                </div>

                                <div>
                                    <label className="block text-xs font-bold text-[#635c4e] uppercase tracking-widest mb-1">Email Details</label>
                                    <input
                                        type="email"
                                        value={data.email}
                                ...
                                {!otpSent && (
                                    <div className="bg-gray-100 p-4 rounded-xl border border-gray-700/50">
                                        <label className="block text-xs font-bold text-[#635c4e] uppercase tracking-widest mb-2">
                                            Prove you are human: <span className="text-[#17150f] text-lg ml-2">{captchaQuestion}</span>
                                        </label>
                                        <div className="flex gap-2">
                                            <input
                                                ...
                                                className="w-full bg-[#f0ece3] border border-gray-600 rounded-lg px-4 py-2 text-[#17150f] focus:border-yellow-500 focus:ring-1 focus:ring-yellow-500 outline-none"
                                                placeholder="Answer"
                                            />
                                            <button
                                                type="button"
                                ...
                                {otpSent && (
                                    <div className="animate-in fade-in slide-in-from-top-2 duration-300">
                                        ...
                                        <input
                                            ...
                                            className="w-full bg-[#f0ece3] border border-green-500/50 rounded-lg px-4 py-3 text-[#17150f] focus:border-green-500 focus:ring-1 focus:ring-green-500 outline-none"
                                            placeholder="6-digit OTP"
                                        />
                                        <div className="text-green-500 text-xs mt-1 flex justify-between">
                                            <span>OTP sent to {data.email}</span>
                                            <button type="button" onClick={() => { setOtpSent(false); fetchCaptcha(); }} className="text-[#635c4e] hover:text-[#17150f] underline">Resend?</button>
                                        </div>
                                ...
                                <div>
                                    <label className="block text-xs font-bold text-[#635c4e] uppercase tracking-widest mb-1">Mobile Number</label>
                                    <input
                                        type="tel"
                                ...
                                <button
                                    ...
                                    className="w-full py-3.5 bg-yellow-600 hover:bg-yellow-500 text-[#17150f] font-bold rounded-xl transition-colors disabled:opacity-50 disabled:cursor-not-allowed mt-2"
                                >
