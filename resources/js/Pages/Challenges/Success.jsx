        ...
        <>
            ...
            <div className="min-h-screen bg-gradient-to-br from-gray-900 via-indigo-950 to-gray-900 flex items-center justify-center p-4">
                <div className="w-full max-w-lg">
                    ...
                    {/* Success Card */}
                    <div className="bg-[#faf8f3] backdrop-blur-xl rounded-3xl border border-[#d8d1c1] shadow-2xl overflow-hidden text-center">
                        ...
                        <div className="pt-12 pb-6">
                            <div className="w-24 h-24 mx-auto mb-6 bg-gradient-to-br from-emerald-500 to-cyan-500 rounded-full flex items-center justify-center shadow-lg shadow-emerald-500/30 animate-bounce">
                                <svg className="w-12 h-12 text-[#17150f]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={3} d="M5 13l4 4L19 7" />
                                </svg>
                            </div>

                            <h1 className="text-3xl font-black text-[#17150f] mb-2">Enrollment Successful!</h1>
                            <p className="text-[#635c4e]">Welcome to the Poetry Challenge</p>
                        </div>

                        {/* Enrollment Details */}
                        <div className="px-8 pb-6">
                            <div className="bg-[#faf8f3] rounded-2xl p-6 border border-[#d8d1c1] text-left">
                                <h3 className="text-[#635c4e] text-xs uppercase tracking-wider mb-4 text-center">Your Enrollment Details</h3>
                                <div className="space-y-3">
                                    <div className="flex justify-between items-center py-2 border-b border-[#d8d1c1]">
                                        <span className="text-[#635c4e]">Name</span>
                                        <span className="text-[#17150f] font-semibold">{enrollment.full_name}</span>
                                    </div>
                                    <div className="flex justify-between items-center py-2 border-b border-[#d8d1c1]">
                                        <span className="text-[#635c4e]">Email</span>
                                        <span className="text-[#17150f] font-semibold">{enrollment.email}</span>
                                    </div>
                                    <div className="flex justify-between items-center py-2 border-b border-[#d8d1c1]">
                                        <span className="text-[#635c4e]">Mobile</span>
                                        <span className="text-[#17150f] font-semibold">{enrollment.mobile_number}</span>
                                    </div>
                                    <div className="flex justify-between items-center py-2 border-b border-[#d8d1c1]">
                                        <span className="text-[#635c4e]">City</span>
                                        <span className="text-[#17150f] font-semibold">{enrollment.city}</span>
                                    </div>
                                    <div className="flex justify-between items-center py-2 border-b border-[#d8d1c1]">
                        ...
                        <div className="px-8 pb-8">
                            <div className="bg-gradient-to-r from-indigo-600/20 to-purple-600/20 rounded-2xl p-6 border border-indigo-500/30 mb-6">
                                <h3 className="text-[#17150f] font-bold text-lg mb-3">🎯 What's Next?</h3>
                            ...
                            <div className="space-y-3">
                                ...
                                <Link
                                    href={route('login')}
                                    className="block w-full py-4 bg-[#e7e1d4] hover:bg-[#e7e1d4] text-[#17150f] font-bold rounded-xl border border-[#d8d1c1] transition-all text-center"
                                >
                        ...
                        {/* Footer */}
                        <div className="border-t border-[#d8d1c1] py-4 bg-[#faf8f3]">
                    ...
                    <div className="mt-6 text-center">
                        <Link
                            href="/"
                            className="text-[#635c4e] hover:text-[#17150f] text-sm transition-colors inline-flex items-center gap-2"
                        >
