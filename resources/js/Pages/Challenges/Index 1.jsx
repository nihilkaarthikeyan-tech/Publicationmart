...
export default function ChallengeIndex({ challengeSettings = {} }) {
    ...
    return (
        <div className="min-h-screen bg-transparent text-white font-sans selection:bg-purple-500 selection:text-white pb-20">
            <PremiumBackground />
                ...
                <div className="bg-indigo-950/20 border border-white/10 rounded-3xl p-8 md:p-12 shadow-2xl shadow-indigo-900/10 backdrop-blur-md">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="pt-6 pb-2 text-center">
                            <div className="inline-block px-6 py-2 bg-white/5 border border-white/10 rounded-xl mb-6 backdrop-blur-sm">
                                <span className="text-gray-400 text-sm mr-2">Entry Fee:</span>
                                <span className="text-lg text-gray-500 line-through mr-2">₹2999</span>
