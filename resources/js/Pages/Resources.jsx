            ...
            <div className="relative pt-32 pb-16">
                ...
                <div className="max-w-7xl mx-auto px-6 relative z-10">
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                        ...
                        <Link href="/how-to-publish" className="group bg-[#faf8f3] rounded-2xl p-8 border border-[#d8d1c1] hover:border-emerald-500/30 transition-all hover:-translate-y-1">
                        ...
                        <Link href="/royalties-calculator" className="group bg-[#faf8f3] rounded-2xl p-8 border border-[#d8d1c1] hover:border-emerald-500/30 transition-all hover:-translate-y-1">
                            <div className="h-48 rounded-xl bg-gradient-to-br from-violet-900/60 to-violet-800/40 mb-6 overflow-hidden relative">
                                <div className="absolute inset-0 bg-indigo-500/20 group-hover:bg-indigo-500/30 transition-colors"></div>
                                <div className="absolute bottom-4 left-4">
                                    <span className="px-3 py-1 bg-[#faf8f3] backdrop-blur-md rounded-lg text-xs font-bold text-[#17150f] border border-[#d8d1c1]">TOOL</span>
                                </div>
                            </div>
                        ...
                        <Link href="/help-center" className="group bg-[#faf8f3] rounded-2xl p-8 border border-[#d8d1c1] hover:border-emerald-500/30 transition-all hover:-translate-y-1">
                            <div className="h-48 rounded-xl bg-gradient-to-br from-violet-900/60 to-violet-800/40 mb-6 overflow-hidden relative">
                                <div className="absolute inset-0 bg-purple-500/20 group-hover:bg-purple-500/30 transition-colors"></div>
                                <div className="absolute bottom-4 left-4">
                                    <span className="px-3 py-1 bg-[#faf8f3] backdrop-blur-md rounded-lg text-xs font-bold text-[#17150f] border border-[#d8d1c1]">SUPPORT</span>
                                </div>
                            </div>
                    ...
                    <div className="mt-24">
                        <div className="flex justify-between items-end mb-10">
                            ...
                            <Link href={route('blogs.index')} className="text-[#635c4e] hover:text-[#17150f] transition-colors">View All Articles</Link>
                        </div>
                        <div className="grid md:grid-cols-3 gap-8">
                            {[1, 2, 3].map((i) => (
                                <div key={i} className="border-b border-[#d8d1c1] pb-8 hover:border-[#d8d1c1] transition-colors">
                                    <span className="text-xs text-[#635c4e] font-mono mb-2 block">Oct {10 + i}, 2025</span>
                                    ...
                                    <p className="text-[#635c4e] text-sm line-clamp-3">
