                ...
                <div className="max-w-7xl mx-auto px-6 relative z-10">
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                        ...
                        <Link href="/how-to-publish" className="group bg-[#262019] rounded-2xl p-8 border border-violet-800/50 hover:border-emerald-500/30 transition-all hover:-translate-y-1">
                            <div className="h-48 rounded-xl bg-gradient-to-br from-violet-900/60 to-violet-800/40 mb-6 overflow-hidden relative">
                                ...
                                <div className="absolute bottom-4 left-4">
                                    <span className="px-3 py-1 bg-black/50 backdrop-blur-md rounded-lg text-xs font-bold text-white border border-white/10">GUIDE</span>
                                </div>
                            </div>
                        ...
                        <Link href="/royalties-calculator" className="group bg-[#262019] rounded-2xl p-8 border border-violet-800/50 hover:border-emerald-500/30 transition-all hover:-translate-y-1">
                            <div className="h-48 rounded-xl bg-gradient-to-br from-violet-900/60 to-violet-800/40 mb-6 overflow-hidden relative">
                                ...
                                <div className="absolute bottom-4 left-4">
                                    <span className="px-3 py-1 bg-black/50 backdrop-blur-md rounded-lg text-xs font-bold text-white border border-white/10">TOOL</span>
                                </div>
                            </div>
                            <h3 className="text-2xl font-bold mb-3 group-hover:text-indigo-400 transition-colors">Royalty Calculator</h3>
                            <p className="text-gray-400 mb-4">
                                Estimate your earnings before you publish. Input your book specifications to see exactly how much you'll make per sale.
                            </p>
                            <span className="text-indigo-400 font-bold text-sm">Calculate Now →</span>
                        </Link>
                        ...
                        <Link href="/help-center" className="group bg-[#262019] rounded-2xl p-8 border border-violet-800/50 hover:border-emerald-500/30 transition-all hover:-translate-y-1">
                            <div className="h-48 rounded-xl bg-gradient-to-br from-violet-900/60 to-violet-800/40 mb-6 overflow-hidden relative">
                                ...
                                <div className="absolute bottom-4 left-4">
                                    <span className="px-3 py-1 bg-black/50 backdrop-blur-md rounded-lg text-xs font-bold text-white border border-white/10">SUPPORT</span>
                                </div>
                            </div>
                            <h3 className="text-2xl font-bold mb-3 group-hover:text-purple-400 transition-colors">Help Center</h3>
                            <p className="text-gray-400 mb-4">
                                Answers to common questions about account management, payment settings, ISBNs, and distribution channels.
                            </p>
                            <span className="text-purple-400 font-bold text-sm">Get Help →</span>
                        </Link>
                    </div>
                    ...
                    <div className="mt-24">
                        <div className="flex justify-between items-end mb-10">
                            ...
                            <Link href={route('blogs.index')} className="text-gray-400 hover:text-white transition-colors">View All Articles</Link>
                        </div>
                        <div className="grid md:grid-cols-3 gap-8">
                            {[1, 2, 3].map((i) => (
                                <div key={i} className="border-b border-white/10 pb-8 hover:border-white/30 transition-colors">
                                    <span className="text-xs text-gray-500 font-mono mb-2 block">Oct {10 + i}, 2025</span>
                                    <h3 className="text-xl font-bold mb-2 hover:text-indigo-400 transition-colors cursor-pointer">
