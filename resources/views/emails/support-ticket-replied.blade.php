...
<head>
    ...
    <style>
        ...
        .ticket-ref span { color: #7c3aed; font-weight: bold; }
        .reply-box { background: #f5f3ff; border: 1px solid #ddd6fe; border-left: 4px solid #7c3aed; border-radius: 8px; padding: 20px; margin: 20px 0; color: #374151; line-height: 1.6; }
        .reply-label { font-size: 12px; color: #7c3aed; font-weight: 700; text-transform: uppercase; margin-bottom: 10px; }
